...
const tableBucketName = `zyraxon-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `zyraxon-${$app.stage}-lake-ingest`,
    destination: "iceberg",
