    ...
    switch (event.type) {
      case 'context-options': {
        if (event.version > latestVersion)
          throw new TraceVersionError('The trace was created by a newer version of Jarvis and is not supported by this version of the viewer. Please use latest Jarvis to open the trace.');
        ...
        contextEntry.jarvisVersion = event.jarvisVersion;
