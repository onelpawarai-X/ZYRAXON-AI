...
/**
 * Jarvis Browser Test supports running multiple test projects at the same time. This is useful for running tests in
 ...
 * [FullProject](https://jarvisbrowser.dev/docs/api/class-fullproject).
 *
 * `TestProject` encapsulates configuration specific to a single project. Projects are configured in
 * [testConfig.projects](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-projects) specified in the
 * [configuration file](https://jarvisbrowser.dev/docs/test-configuration). Note that all properties of
 * [TestProject](https://jarvisbrowser.dev/docs/api/class-testproject) are available in the top-level
 * [TestConfig](https://jarvisbrowser.dev/docs/api/class-testconfig), in which case they are shared between all projects.
 *
...
interface TestProject<TestArgs = {}, WorkerArgs = {}> {
   ...
   * [testOptions.browserName](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-browser-name). Learn more
   * about [configuration](https://jarvisbrowser.dev/docs/test-configuration) and see
   * [available options][TestOptions](https://jarvisbrowser.dev/docs/api/class-testoptions).
   *
   * ```js
   * // jarvis.config.ts
   ...
   * ```
   *
   * Use [testConfig.use](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-use) to change this option for
   * all projects.
   */
   ...
   *
   * Use [testConfig.expect](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-expect) to change this option
   * for all projects.
   */
  expect?: {
    /**
     ...
     * [expect(page).toHaveScreenshot(name[, options])](https://jarvisbrowser.dev/docs/api/class-pageassertions#page-assertions-to-have-screenshot-1)
     * method.
     */
    toHaveScreenshot?: {
      /**
      ...
      /**
       * See [`animations`](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot-option-animations) in
       * [page.screenshot([options])](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot). Defaults to `"disabled"`.
       */
      animations?: "allow"|"disabled";

      /**
       * See [`caret`](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot-option-caret) in
       * [page.screenshot([options])](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot). Defaults to `"hide"`.
       */
      caret?: "hide"|"initial";

      /**
       * See [`scale`](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot-option-scale) in
       * [page.screenshot([options])](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot). Defaults to `"css"`.
       */
      scale?: "css"|"device";

      /**
       * See [`style`](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot-option-style) in
       * [page.screenshot([options])](https://jarvisbrowser.dev/docs/api/class-page#page-screenshot).
       */
      stylePath?: string|Array<string>;

      /**
       * A template controlling location of the screenshots. See
       * [testProject.snapshotPathTemplate](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-snapshot-path-template)
       * for details.
       */
      pathTemplate?: string;
    ...
    /**
     * Configuration for the
     * [expect(locator).toMatchAriaSnapshot([options])](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-match-aria-snapshot-2)
     * method.
     */
    toMatchAriaSnapshot?: {
      /**
    ...
    /**
     * Configuration for the
     * [expect(value).toMatchSnapshot(name[, options])](https://jarvisbrowser.dev/docs/api/class-snapshotassertions#snapshot-assertions-to-match-snapshot-1)
     * method.
     */
    toMatchSnapshot?: {
      /**
    ...
    /**
     * Configuration for the [expect(value).toPass()](https://jarvisbrowser.dev/docs/test-assertions) method.
     */
    toPass?: {
      /**
  ...
  /**
   * Jarvis Browser Test runs tests in parallel. In order to achieve that, it runs several worker processes that run at the
   ...
   * run tests with "cart" in the title. Also available globally and in the [command line](https://jarvisbrowser.dev/docs/test-cli) with the `-g`
   ...
   *
   * `grep` option is also useful for [tagging tests](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   */
  grep?: RegExp|Array<RegExp>;

  /**
   * Filter to only run tests with a title **not** matching any of the patterns. This is the opposite of
   * [testProject.grep](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-grep). Also available globally
   * and in the [command line](https://jarvisbrowser.dev/docs/test-cli) with the `--grep-invert` option.
   *
   * `grepInvert` option is also useful for [tagging tests](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   */
   ...
   *
   * **NOTE** Jarvis executes the configuration file multiple times. Do not dynamically produce non-stable values in
   * your configuration.
   *
   */
  name?: string;
   ...
   * [testProject.outputDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-output-dir) is created,
   * guaranteeing that test running in parallel do not conflict. This directory can be accessed by
   * [testInfo.outputDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-dir) and
   * [testInfo.outputPath(...pathSegments)](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-path).
   *
   * Here is an example that uses
   * [testInfo.outputPath(...pathSegments)](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-path) to
   ...
   * ```
   *
   * Use [testConfig.outputDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-output-dir) to change this
   ...
   *
   * Use [testConfig.repeatEach](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-repeat-each) to change
   ...
   * [testConfig.testDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-dir) nor
   * [testProject.testDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-dir) are explicitly
   * specified, Jarvis will ignore any test files matching `.gitignore` entries. This option allows to override that
   * behavior.
   */
   ...
   * [test retries](https://jarvisbrowser.dev/docs/test-retries#retries).
   *
   * Use [test.describe.configure([options])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-configure) to
   * change the number of retries for a specific file or a group of tests.
   *
   * Use [testConfig.retries](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-retries) to change this
   * option for all projects.
   */
  retries?: number;
   ...
   * [testProject.testDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-dir).
   *
   * The directory for each test can be accessed by
   * [testInfo.snapshotDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-dir) and
   * [testInfo.snapshotPath(...name[, options])](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-path).
   *
   * This path will serve as the base directory for each test file snapshot directory. Setting `snapshotDir` to
   * `'snapshots'`, the [testInfo.snapshotDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-dir)
   ...
   * [testConfig.expect](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-expect).
   *
   * **Usage**
   *
   * ```js
   ...
   *   [testProject.snapshotDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-snapshot-dir).
   *   - Value: `/home/jarvis/tests` (since `snapshotDir` is not provided in config, it defaults to `testDir`)
   * - `{testDir}` - Project's
   *   [testProject.testDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-dir).
   *   - Value: `/home/jarvis/tests` (absolute path since `testDir` is resolved relative to directory with
   *     config)
   ...
   * [testProject.teardown](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-teardown) and behaves as if
   ...
   * ```
   *
   * Use [testConfig.testDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-dir) to change this
   * option for all projects.
   */
  testDir?: string;
   ...
   *
   * Use [testConfig.testIgnore](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-ignore) to change
   * this option for all projects.
   */
   ...
   *
   * By default, Jarvis looks for files matching the following glob pattern: `**\/*.@(spec|test).?(c|m)[jt]s?(x)`.
   * This means JavaScript or TypeScript files with `".test"` or `".spec"` suffix, for example
   * `login-screen.wrong-credentials.spec.ts`.
   *
   * Use [testConfig.testMatch](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-match) to change this
   * option for all projects.
   */
   ...
   * [test.setTimeout(timeout)](https://jarvisbrowser.dev/docs/api/class-test#test-set-timeout). Each file or a group of
   * tests can configure the timeout with
   * [test.describe.configure([options])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-configure).
   *
   * Use [testConfig.timeout](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-timeout) to change this
   * option for all projects.
   */
  timeout?: number;
   ...
   *
   * Note that the global [testConfig.workers](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-workers)
   * limit applies to the total number of worker processes. However, Jarvis will limit the number of workers used
   * for this project by the value of
   * [testProject.workers](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-workers).
   *
   * By default, there is no limit per project. See
   * [testConfig.workers](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-workers) for the default of the
   * total worker limit.
   *
   * **Usage**
   *
 ...
 * [testInfo.project](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-project) and
 * [workerInfo.project](https://jarvisbrowser.dev/docs/api/class-workerinfo#worker-info-project) and is passed to the
 * test reporters. To see the format of the project in the Jarvis configuration file please see
 * [TestProject](https://jarvisbrowser.dev/docs/api/class-testproject) instead.
 */
export interface FullProject<TestArgs = {}, WorkerArgs = {}> {
  /**
   * See [testProject.use](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-use).
   */
  use: UseOptions<JarvisTestOptions & TestArgs, JarvisWorkerOptions & WorkerArgs>;
  /**
   * See [testProject.dependencies](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-dependencies).
   */
  dependencies: Array<string>;

  /**
   * See [testProject.grep](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-grep).
   */
  grep: RegExp|Array<RegExp>;

  /**
   * See [testProject.grepInvert](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-grep-invert).
   */
  grepInvert: null|RegExp|Array<RegExp>;

  /**
   * See [testProject.ignoreSnapshots](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-ignore-snapshots).
   */
  ignoreSnapshots: boolean;

  /**
   * See [testProject.metadata](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-metadata).
   */
  metadata: Metadata;

  /**
   * See [testProject.name](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-name).
   */
  name: string;

  /**
   * See [testProject.outputDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-output-dir).
   */
  outputDir: string;

  /**
   * See [testProject.repeatEach](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-repeat-each).
   */
  repeatEach: number;

  /**
   * See [testProject.retries](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-retries).
   */
  retries: number;

  /**
   * See [testProject.snapshotDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-snapshot-dir).
   */
  snapshotDir: string;

  /**
   * See [testProject.teardown](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-teardown).
   */
  teardown?: string;

  /**
   * See [testProject.testDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-dir).
   */
  testDir: string;

  /**
   * See [testProject.testIgnore](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-ignore).
   */
  testIgnore: string|RegExp|Array<string|RegExp>;

  /**
   * See [testProject.testMatch](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-match).
   */
  testMatch: string|RegExp|Array<string|RegExp>;

  /**
   * See [testProject.timeout](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-timeout).
   */
  timeout: number;
}
...
/**
 * Jarvis Browser Test provides many options to configure how your tests are collected and executed, for example `timeout`
 * or `testDir`. These options are described in the [TestConfig](https://jarvisbrowser.dev/docs/api/class-testconfig)
 * object in the [configuration file](https://jarvisbrowser.dev/docs/test-configuration). This type describes format of the configuration file,
 * to access resolved configuration parameters at run time use
 * [FullConfig](https://jarvisbrowser.dev/docs/api/class-fullconfig).
 *
 * Jarvis Browser Test supports running multiple test projects at the same time. Project-specific options should be put to
 * [testConfig.projects](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-projects), but top-level
 * [TestConfig](https://jarvisbrowser.dev/docs/api/class-testconfig) can also define base options shared between all
 * projects.
 *
 * ```js
 * // jarvis.config.ts
...
interface TestConfig<TestArgs = {}, WorkerArgs = {}> {
  /**
   * Jarvis Browser Test supports running multiple test projects at the same time. See
   * [TestProject](https://jarvisbrowser.dev/docs/api/class-testproject) for more information.
   *
   * **Usage**
   *
   * ```js
   ...
   * is not specified, Jarvis uses the `'dot'` reporter when the CI environment variable is set, and the `'list'`
   * reporter otherwise.
   *
   * Learn more in the [reporters guide](https://jarvisbrowser.dev/docs/test-reporters).
   *
   * **Usage**
   *
   * ```js
   ...
   * **Details**
   *
   * If the port is specified, Jarvis Browser Test will wait for it to be available on `127.0.0.1` or `::1`, before running
   * the tests. If the url is specified, Jarvis Browser Test will wait for the URL to return a 2xx, 3xx, 400, 401, 402, or
   ...
   *
   * The `port` (but not the `url`) gets passed over to Jarvis as a
   * [testOptions.baseURL](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-base-url). For example port
   ...
   * [testOptions.baseURL](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-base-url) in the config, so
  ...
  /**
   * Jarvis transpiler configuration.
   *
   * **Usage**
   *
   * ```js
   ...
   * [testConfig.metadata](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-metadata).
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Configuration for the `expect` assertion library. Learn more about [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * **Usage**
   *
   * ```js
  ...
  expect?: {
    ...
    toHaveScreenshot?: {
      ...
      /**
       * A template controlling location of the screenshots. See
       * [testConfig.snapshotPathTemplate](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-snapshot-path-template)
       * for details.
       */
      pathTemplate?: string;
    };
    ...
    /**
     * Configuration for the [expect(value).toPass()](https://jarvisbrowser.dev/docs/test-assertions#expecttopass) method.
     */
    toPass?: {
      /**
       * Probe intervals for toPass method in milliseconds.
   ...
   *
   * Also available in the [command line](https://jarvisbrowser.dev/docs/test-cli) with the `--fail-on-flaky-tests` option.
   *
   * **Usage**
   *
   * ```js
   ...
   * [test.only(title[, details, body])](https://jarvisbrowser.dev/docs/api/class-test#test-only) or
   * [test.describe.only([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-only).
   * Useful on CI.
   *
   * **Usage**
   *
   ...
   * function that takes a [FullConfig](https://jarvisbrowser.dev/docs/api/class-fullconfig) argument. Pass an array of
   * paths to specify multiple global setup files.
   *
   * Learn more about [global setup and teardown](https://jarvisbrowser.dev/docs/test-global-setup-teardown).
   *
   * **Usage**
   *
   * ```js
   ...
   * function. See also
   * [testConfig.globalSetup](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-global-setup). Pass an array
   ...
   * [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Filter to only run tests with a title matching one of the patterns. For example, passing `grep: /cart/` should only
   * run tests with "cart" in the title. Also available in the [command line](https://jarvisbrowser.dev/docs/test-cli) with the `-g` option. The
   ...
   * [testConfig.grep](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-grep). Also available in the
   * [command line](https://jarvisbrowser.dev/docs/test-cli) with the `--grep-invert` option.
   *
   * `grepInvert` option is also useful for [tagging tests](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   *
   * **Usage**
   ...
   *
   * Also available in the [command line](https://jarvisbrowser.dev/docs/test-cli) with the `--max-failures` and `-x` options.
   *
   * **Usage**
   *
   * ```js
   ...
   * [testProject.name](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-name).
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * This directory is cleaned at the start. When running a test, a unique subdirectory inside the
   * [testConfig.outputDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-output-dir) is created,
   * guaranteeing that test running in parallel do not conflict. This directory can be accessed by
   * [testInfo.outputDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-dir) and
   * [testInfo.outputPath(...pathSegments)](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-path).
   *
   ...
   * [testConfig.outputDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-output-dir). Defaults to
   * `'always'`.
   ...
   * [testConfig.testDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-dir) nor
   * [testProject.testDir](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-test-dir) are explicitly
   * specified, Jarvis will ignore any test files matching `.gitignore` entries.
   */
  respectGitIgnore?: boolean;

  /**
   * The maximum number of retry attempts given to failed tests. By default failing tests are not retried. Learn more
   * about [test retries](https://jarvisbrowser.dev/docs/test-retries#retries).
   *
   * **Usage**
   *
   * ```js
   ...
   *   run time.
   *
   * Learn more about [test retries](https://jarvisbrowser.dev/docs/test-retries#retries).
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * Learn more about [parallelism and sharding](https://jarvisbrowser.dev/docs/test-parallel) with Jarvis Browser Test.
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * The base directory, relative to the config file, for snapshot files created with `toMatchSnapshot`. Defaults to
   * [testConfig.testDir](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-test-dir).
   *
   * **Usage**
   *
   * ```js
   ...
   * [CI environments](https://jarvisbrowser.dev/docs/test-sharding#merging-reports-from-multiple-environments).
   *
   * Note that each tag must start with `@` symbol. Learn more about [tagging](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   *
   * **Usage**
   *
   * ```js
   ...
   * [test.setTimeout(timeout)](https://jarvisbrowser.dev/docs/api/class-test#test-set-timeout). Learn more about
   * [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * **Usage**
   *
   ...
   *
   * Learn more about [snapshots](https://jarvisbrowser.dev/docs/test-snapshots).
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * Jarvis Browser Test uses worker processes to run tests. There is always at least one worker process, but more can be
   * used to speed up test execution.
   *
   * Defaults to half of the number of logical CPU cores. Learn more about
   * [parallelism and sharding](https://jarvisbrowser.dev/docs/test-parallel) with Jarvis Browser Test.
   *
   * **Usage**
   *
   * ```js
 ...
 * [testInfo.config](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-config) and is passed to the test
 * reporters. To see the format of Jarvis configuration file, please see
 * [TestConfig](https://jarvisbrowser.dev/docs/api/class-testconfig) instead.
 */
export interface FullConfig<TestArgs = {}, WorkerArgs = {}> {
  ...
  /**
   * See [testConfig.reporter](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-reporter).
   */
  reporter: ReporterDescription[];
  /**
   * See [testConfig.webServer](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-web-server).
   */
   ...
   * Jarvis Browser Test -- --build-path=./out`). Jarvis does not parse these; consumers are responsible for slicing and
  ...
  /**
   * See
   * [testConfig.failOnFlakyTests](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-fail-on-flaky-tests).
   */
  failOnFlakyTests: boolean;

  /**
   * See [testConfig.forbidOnly](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-forbid-only).
   */
  forbidOnly: boolean;

  /**
   * See [testConfig.fullyParallel](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-fully-parallel).
   */
  fullyParallel: boolean;

  /**
   * See [testConfig.globalSetup](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-global-setup).
   */
  globalSetup: null|string;

  /**
   * See [testConfig.globalTeardown](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-global-teardown).
   */
  globalTeardown: null|string;

  /**
   * See [testConfig.globalTimeout](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-global-timeout).
   */
  globalTimeout: number;

  /**
   * See [testConfig.grep](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-grep).
   */
  grep: RegExp|Array<RegExp>;

  /**
   * See [testConfig.grepInvert](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-grep-invert).
   */
  grepInvert: null|RegExp|Array<RegExp>;

  /**
   * See [testConfig.maxFailures](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-max-failures).
   */
  maxFailures: number;

  /**
   * See [testConfig.metadata](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-metadata).
   */
  metadata: Metadata;

  /**
   * See [testConfig.preserveOutput](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-preserve-output).
   */
  preserveOutput: "always"|"never"|"failures-only";

  /**
   * See [testConfig.quiet](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-quiet).
   */
  quiet: boolean;

  /**
   * See [testConfig.reportSlowTests](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-report-slow-tests).
   */
  reportSlowTests: null|{
    /**
  ...
  /**
   * See [testConfig.shard](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-shard).
   */
  shard: null|{
    /**
     * The total number of shards.
  ...
  /**
   * Resolved global tags. See [testConfig.tag](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-tag).
   */
  tags: Array<string>;

  /**
   * See [testConfig.updateSnapshots](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-update-snapshots).
   */
  updateSnapshots: "all"|"changed"|"missing"|"none";

  /**
   * See
   * [testConfig.updateSourceMethod](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-update-source-method).
   */
  updateSourceMethod: "overwrite"|"3way"|"patch";
  ...
  /**
   * See [testConfig.workers](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-workers).
   */
  workers: number;
}
 ...
 * [test.beforeEach([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-before-each),
 * [test.afterEach([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-each),
 * [test.beforeAll([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-before-all) and
 * [test.afterAll([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-all) hooks, and
...
export interface TestInfo {
   ...
   * [`kind`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-path-option-kind) to obtain a specific
   * path:
   * - `kind: 'screenshot'` for
   *   [expect(page).toHaveScreenshot(name[, options])](https://jarvisbrowser.dev/docs/api/class-pageassertions#page-assertions-to-have-screenshot-1);
   * - `kind: 'aria'` for
   *   [expect(locator).toMatchAriaSnapshot(expected[, options])](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-match-aria-snapshot);
   * - `kind: 'snapshot'` for
   *   [expect(value).toMatchSnapshot(name[, options])](https://jarvisbrowser.dev/docs/api/class-snapshotassertions#snapshot-assertions-to-match-snapshot-1).
   *
   * **Usage**
   ...
   *
   * When passing [`kind`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-path-option-kind), multiple
   ...
   * [`path`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach-option-path) or
   * [`body`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach-option-body) must be specified, but not
   * both.
   *
   ...
   * ```
   *
   * **NOTE** [testInfo.attach(name[, options])](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach)
  ...
  attach(name: string, options?: {
     ...
     * [`path`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach-option-path).
     */
    body?: string|Buffer;
     ...
     * [`path`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach-option-path), or defaults to `text/plain`
     ...
     * [`body`](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach-option-body).
     */
    path?: string;
  }): Promise<void>;

  /**
   * Marks the currently running test as "should fail". Jarvis Browser Test runs this test and ensures that it is actually
   ...
   * [test.fail([title, details, body, condition, callback, description])](https://jarvisbrowser.dev/docs/api/class-test#test-fail).
   */
  fail(): void;
   ...
   * [test.fixme([title, details, body, condition, callback, description])](https://jarvisbrowser.dev/docs/api/class-test#test-fixme).
   */
  fixme(): void;
  ...
  /**
   * Returns a path inside the [testInfo.outputDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-dir)
   ...
   * [testInfo.outputDir](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-output-dir) directory for each test
   ...
   * [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * Timeout is usually specified in the [configuration file](https://jarvisbrowser.dev/docs/test-configuration), but it could be useful to
   ...
   * [test.skip([title, details, body, condition, callback, description])](https://jarvisbrowser.dev/docs/api/class-test#test-skip).
   */
  skip(): void;
   ...
   * [test.slow([condition, callback, description])](https://jarvisbrowser.dev/docs/api/class-test#test-slow).
   */
  slow(): void;
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) groups the
   * test belongs to and file-level annotations for the test file.
   *
   * Learn more about [test annotations](https://jarvisbrowser.dev/docs/test-annotations).
   */
  annotations: Array<{
    /**
   ...
   * [testInfo.attach(name[, options])](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach) instead of
  ...
  /**
   * Processed configuration from the [configuration file](https://jarvisbrowser.dev/docs/test-configuration).
   */
  config: FullConfig;
   ...
   * not. Can be used in
   * [test.afterEach([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-each) hook.
   */
  duration: number;

  /**
   * First error thrown during test execution, if any. This is equal to the first element in
   * [testInfo.errors](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-errors).
   */
  error?: TestInfoError;
   ...
   * [testInfo.status](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-status):
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
  ...
  /**
   * Processed project configuration from the [configuration file](https://jarvisbrowser.dev/docs/test-configuration).
   */
  project: FullProject;

  /**
   * Specifies a unique repeat index when running in "repeat each" mode. This mode is enabled by passing `--repeat-each`
   * to the [command line](https://jarvisbrowser.dev/docs/test-cli).
   */
  repeatEachIndex: number;

  /**
   * Specifies the retry number when the test is retried after a failure. The first test run has
   * [testInfo.retry](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-retry) equal to zero, the first retry has
   * it equal to one, and so on. Learn more about [retries](https://jarvisbrowser.dev/docs/test-retries#retries).
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
  ...
  /**
   * **NOTE** Use of [testInfo.snapshotSuffix](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-snapshot-suffix)
   ...
   * about [snapshots](https://jarvisbrowser.dev/docs/test-snapshots).
   */
  snapshotSuffix: string;

  /**
   * Actual status for the currently running test. Available after the test has finished in
   * [test.afterEach([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-each) hook and
   * fixtures.
   *
   * Status is usually compared with the
   * [testInfo.expectedStatus](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-expected-status):
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
  ...
  /**
   * Tags that apply to the test. Learn more about [tags](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   *
   ...
   * [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * Timeout is usually specified in the [configuration file](https://jarvisbrowser.dev/docs/test-configuration)
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
   ...
   *
   * Also available as `process.env.TEST_WORKER_INDEX`. Learn more about [parallelism and sharding](https://jarvisbrowser.dev/docs/test-parallel)
   * with Jarvis Browser Test.
   */
  workerIndex: number;
}
...
export interface TestType<TestArgs extends {}, WorkerArgs extends {}> {
   ...
   * - in the [command line](https://jarvisbrowser.dev/docs/test-cli#all-options);
   * - in the config with [testConfig.grep](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-grep) and
   *   [testProject.grep](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-grep);
   *
   * Learn more about [tagging](https://jarvisbrowser.dev/docs/test-annotations#tag-tests).
   *
   * **Annotations**
   *
   ...
   * [testInfo.annotations](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-annotations).
   *
   * Learn more about [test annotations](https://jarvisbrowser.dev/docs/test-annotations).
   *
   * **Locks**
   ...
   * files or belong to different [projects](https://jarvisbrowser.dev/docs/test-projects). This is useful when a few tests access a shared
   ...
   * ```
   *
   * Learn more about [test locks](https://jarvisbrowser.dev/docs/test-parallel#test-locks).
   ...
   * [TestInfo](https://jarvisbrowser.dev/docs/api/class-testinfo).
   */
   ...
   *
   * @param title Test title.
   * @param details See [test.(call)(title[, details, body])](https://jarvisbrowser.dev/docs/api/class-test#test-call) for test details
   * description.
   * @param body Test body that takes one or two arguments: an object with fixtures and optional
   * [TestInfo](https://jarvisbrowser.dev/docs/api/class-testinfo).
   */
   ...
   * [test.use(options)](https://jarvisbrowser.dev/docs/api/class-test#test-use).
   *
   * ```js
   * test.describe(() => {
   ...
   * never run concurrently. Learn more about [test locks](https://jarvisbrowser.dev/docs/test-parallel#test-locks).
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe). Any tests
  ...
  describe: {
     ...
     *
     * @param title Group title.
     * @param details See [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) for
     * details description.
     * @param callback A callback that is run immediately when calling
     * [test.describe.only([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-only).
     ...
     * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe). Tests in the
     ...
     * details description.
     * @param callback A callback that is run immediately when calling
     * [test.describe.skip(title[, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-skip).
     ...
     * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe). Tests in
     ...
     * details description.
     * @param callback A callback that is run immediately when calling
     * [test.describe.fixme([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-fixme).
     * Any tests added in this callback will belong to the group, and will not be run.
     */
    ...
    /**
     * **NOTE** See [test.describe.configure([options])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-configure) for
     ...
     * details description.
     * @param callback A callback that is run immediately when calling
     * [test.describe.serial([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-serial).
     * Any tests added in this callback will belong to the group.
     */
    serial: {
      /**
       ...
       * details description.
       * @param callback A callback that is run immediately when calling
       * [test.describe.serial.only(title[, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-serial-only).
       * Any tests added in this callback will belong to the group.
       */
      only(title: string, callback: () => void): void;
      /**
     ...
     * another, but using
     * [test.describe.parallel([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-parallel)
    ...
    parallel: {
       ...
       * details description.
       * @param callback A callback that is run immediately when calling
       * [test.describe.parallel.only([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe-parallel-only).
       * Any tests added in this callback will belong to the group.
       */
      only(title: string, callback: () => void): void;
      /**
     ...
     *
     * Learn more about the execution modes [here](https://jarvisbrowser.dev/docs/test-parallel).
     *
     * **Usage**
  ...
  /**
   * Skip a test. Jarvis will not run the test past the `test.skip()` call.
   *
   ...
   * **Usage**
   *
   * You can declare a skipped test, and Jarvis will not run it.
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
   ...
   * based on some condition. We recommend passing a `description` argument in this case. Jarvis will run the test,
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) group based
  ...
  /**
   * Mark a test as "fixme", with the intention to fix it. Jarvis will not run the test past the `test.fixme()`
   * call.
   *
   ...
   * **Usage**
   *
   * You can declare a test as to be fixed, and Jarvis will not run it.
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
   ...
   * body based on some condition. We recommend passing a `description` argument in this case. Jarvis will run the
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) group as
  ...
  /**
   * Marks a test as "should fail". Jarvis runs this test and ensures that it is actually failing. This is useful
   ...
   * **Usage**
   *
   * You can declare a test as failing, so that Jarvis ensures it actually fails.
   *
   * ```js
   * import { test, expect } from '@jarvis-browser/test';
   *
  ...
  fail: {
     ...
     * **Usage**
     *
     * You can declare a focused failing test, so that Jarvis runs only this test and ensures it actually fails.
     *
     * ```js
     * import { test, expect } from '@jarvis-browser/test';
     *
     ...
     *
     * @param title Test title.
     * @param details See [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) for test
     * details description.
     * @param body Test body that takes one or two arguments: an object with fixtures and optional
     * [TestInfo](https://jarvisbrowser.dev/docs/api/class-testinfo).
     */
   ...
   *
   * Note that [test.slow([condition, callback, description])](https://jarvisbrowser.dev/docs/api/class-test#test-slow)
   * cannot be used in a `beforeAll` or `afterAll` hook. Use
   * [test.setTimeout(timeout)](https://jarvisbrowser.dev/docs/api/class-test#test-set-timeout) instead.
   * - `test.slow()`
  ...
  /**
   * Changes the timeout for the test. Zero means no timeout. Learn more about [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   *
   * Timeout for the currently running test is available through
   * [testInfo.timeout](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-timeout).
   *
   * **Usage**
   ...
   *   [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) group.
   *
   *   ```js
   *   test.describe('group', () => {
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) group, runs
   * before each test in the group.
   *
   * You can access all the same [Fixtures](https://jarvisbrowser.dev/docs/api/class-fixtures) as the test body itself, and
   * also the [TestInfo](https://jarvisbrowser.dev/docs/api/class-testinfo) object that gives a lot of useful information.
   * For example, you can navigate the page before starting the test.
   *
   * You can use [test.afterEach([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-each) to
   ...
   *
   * Jarvis will continue running all applicable hooks even if some of them have failed.
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * You can use [test.afterAll([title, hookFunction])](https://jarvisbrowser.dev/docs/api/class-test#test-after-all) to
   ...
   * more about [workers and failures](https://jarvisbrowser.dev/docs/test-retries).
   *
   * Jarvis will continue running all applicable hooks even if some of them have failed.
   *
   * **Usage**
   ...
   * [test.describe([title, details, callback])](https://jarvisbrowser.dev/docs/api/class-test#test-describe) group. Most
  ...
  step: {
     ...
     * planned for a near-term fix. Jarvis will not run the step. See also
     * [testStepInfo.skip(condition[, description])](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-skip-2).
     *
     * We recommend [testStepInfo.skip()](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-skip-1)
     * instead.
     *
     * **Usage**
     *
     * You can declare a skipped step, and Jarvis will not run it.
     *
     * ```js
     * import { test, expect } from '@jarvis-browser/test';
     *
  ...
  /**
   * `expect` function can be used to create test assertions. Read more about [test assertions](https://jarvisbrowser.dev/docs/test-assertions).
   *
   * **Usage**
   *
   * ```js
   ...
   * ```
   *
   * Learn more about [fixtures](https://jarvisbrowser.dev/docs/test-fixtures) and [parametrizing tests](https://jarvisbrowser.dev/docs/test-parameterize).
   * @param fixtures An object containing fixtures and/or options. Learn more about [fixtures format](https://jarvisbrowser.dev/docs/test-fixtures).
   */
...
/**
 * Jarvis Browser Test provides many options to configure test environment,
 * [Browser](https://jarvisbrowser.dev/docs/api/class-browser),
 * [BrowserContext](https://jarvisbrowser.dev/docs/api/class-browsercontext) and more.
 *
 * These options are usually provided in the [configuration file](https://jarvisbrowser.dev/docs/test-configuration) through
 * [testConfig.use](https://jarvisbrowser.dev/docs/api/class-testconfig#test-config-use) and
 * [testProject.use](https://jarvisbrowser.dev/docs/api/class-testproject#test-project-use).
 *
 * ```js
 * // jarvis.config.ts
 * import { defineConfig } from '@jarvis-browser/test';
 ...
 * ```
 *
 * Alternatively, with [test.use(options)](https://jarvisbrowser.dev/docs/api/class-test#test-use) you can override some
 * options for a file.
 *
 * ```js
 * // example.spec.ts
...
export interface JarvisWorkerOptions {
   ...
   * your [TestConfig](https://jarvisbrowser.dev/docs/api/class-testconfig):
   *
   * **Usage**
   *
   * ```js
   ...
   *
   * Use "chromium" to [opt in to new headless mode](https://jarvisbrowser.dev/docs/browsers#chromium-new-headless-mode).
   *
   * Use "chrome", "chrome-beta", "chrome-dev", "chrome-canary", "msedge", "msedge-beta", "msedge-dev", or
   * "msedge-canary" to use branded [Google Chrome and ZYRAXON Edge](https://jarvisbrowser.dev/docs/browsers#google-chrome--microsoft-edge).
   *
   * **Usage**
   *
   * ```js
   ...
   * [browserType.launch([options])](https://jarvisbrowser.dev/docs/api/class-browsertype#browser-type-launch). Specific
   * options [testOptions.headless](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-headless) and
   * [testOptions.channel](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-channel) take priority over
   * this.
   *
   * **NOTE** Use custom browser args at your own risk, as some of them may break Jarvis functionality.
   *
   * **Usage**
   *
   * ```js
   ...
   * [fixtures.browser](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-browser),
   * [fixtures.context](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-context) and
   * [fixtures.page](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-page) use the remote browser instead of
   * launching a browser locally, and any launch options like
   * [testOptions.headless](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-headless) or
   * [testOptions.channel](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-channel) are ignored.
   */
   ...
   * it unset for end-to-end tests - a fresh browser context per test is one of the core guarantees of Jarvis Browser Test.
   *
   ...
   *
   * Between tests, Jarvis resets the state that component tests typically touch: it clears cookies, cache, local
   ...
   *   [browserContext.grantPermissions(permissions[, options])](https://jarvisbrowser.dev/docs/api/class-browsercontext#browser-context-grant-permissions)
   *   during a test.
   * - Runtime changes made through
   *   [browserContext.setGeolocation(geolocation)](https://jarvisbrowser.dev/docs/api/class-browsercontext#browser-context-set-geolocation),
   *   [browserContext.setOffline(offline)](https://jarvisbrowser.dev/docs/api/class-browsercontext#browser-context-set-offline)
   *   and
   *   [browserContext.setExtraHTTPHeaders(headers)](https://jarvisbrowser.dev/docs/api/class-browsercontext#browser-context-set-extra-http-headers).
   * - Browsing history, `window.name` and any browser-process-wide state.
   *
   * Additional restrictions:
   * - The option is ignored when
   *   [testOptions.video](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-video) recording is enabled.
   ...
   *   in [test.use(options)](https://jarvisbrowser.dev/docs/api/class-test#test-use), for example `locale` or
   *   `storageState`, silently forces a fresh context and negates the speedup.
   * - Do not combine with
   *   [testOptions.connectOptions](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-connect-options)
   *   pointing multiple workers at a shared browser - workers would compete for the single reusable context.
   * - `recordHar` in
   *   [testOptions.contextOptions](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-context-options) is
   ...
   * ```
   *
   * Learn more about [automatic screenshots](https://jarvisbrowser.dev/docs/test-use-options#recording-options).
   */
  screenshot: ScreenshotMode | { mode: ScreenshotMode } & Pick<PageScreenshotOptions, 'fullPage' | 'omitBackground'>;
  /**
   * Whether to record trace for each test. Defaults to `'off'`. The initial run of a test is the "first run";
   * subsequent runs caused by [retries](https://jarvisbrowser.dev/docs/test-retries) are "retries".
   ...
   *   a retry.
   *
   * See [trace modes](https://jarvisbrowser.dev/docs/test-use-options#trace-modes) for a side-by-side comparison of what each mode records and
   * keeps.
   *
   ...
   * ```
   *
   * Learn more about [recording trace](https://jarvisbrowser.dev/docs/test-use-options#recording-options).
   */
   ...
   *   a retry.
   *
   * See [video modes](https://jarvisbrowser.dev/docs/test-use-options#video-modes) for a side-by-side comparison of what each mode records and
   * keeps.
   *
   * To control video size, pass an object with `mode` and `size` properties. If video size is not specified, it will be
   * equal to [testOptions.viewport](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-viewport) scaled
   ...
   * ```
   *
   * Learn more about [recording video](https://jarvisbrowser.dev/docs/test-use-options#recording-options).
   */
...
export interface JarvisTestOptions {
   ...
   * [page.emulateMedia([options])](https://jarvisbrowser.dev/docs/api/class-page#page-emulate-media) for more details.
   ...
   * work by replacing `localhost` with `local.jarvis`.
   *
   * **Usage**
   *
   * ```js
   ...
   * [emulating devices with device scale factor](https://jarvisbrowser.dev/docs/emulation#devices).
   *
   * **Usage**
   *
   * ```js
   ...
   * ```
   *
   * Learn more about [geolocation](https://jarvisbrowser.dev/docs/emulation#color-scheme-and-media).
   */
  geolocation: Geolocation | undefined;
  /**
   * Specifies if viewport supports touch events. Defaults to false. Learn more about
   * [mobile emulation](https://jarvisbrowser.dev/docs/emulation#devices).
   *
   * **Usage**
   *
   * ```js
   ...
   * about [mobile emulation](https://jarvisbrowser.dev/docs/emulation#ismobile).
   *
   * **Usage**
   *
   * ```js
   ...
   * [disabling JavaScript](https://jarvisbrowser.dev/docs/emulation#javascript-enabled).
   *
   * **Usage**
   *
   * ```js
   ...
   * about emulation in our [emulation guide](https://jarvisbrowser.dev/docs/emulation#locale--timezone).
   *
   * **Usage**
   *
   * ```js
   ...
   * [network emulation](https://jarvisbrowser.dev/docs/emulation#offline).
   *
   * **Usage**
   *
   * ```js
   ...
   * through [page.pierceFrames([options])](https://jarvisbrowser.dev/docs/api/class-page#page-pierce-frames). Defaults to
   * `false`.
   *
   * **Usage**
   *
  ...
  /**
   * Learn more about [storage state and auth](https://jarvisbrowser.dev/docs/auth).
   *
   * Populates context with given storage state. This option can be used to initialize context with logged-in
   * information obtained via
   * [browserContext.storageState([options])](https://jarvisbrowser.dev/docs/api/class-browsercontext#browser-context-storage-state).
   *
   * **Usage**
   *
   * ```js
   ...
   * viewport emulation. Learn more about [viewport emulation](https://jarvisbrowser.dev/docs/emulation#viewport).
   *
  ...
  /**
   * When using [page.goto(url[, options])](https://jarvisbrowser.dev/docs/api/class-page#page-goto),
   * [page.route(url, handler[, options])](https://jarvisbrowser.dev/docs/api/class-page#page-route),
   * [page.waitForURL(url[, options])](https://jarvisbrowser.dev/docs/api/class-page#page-wait-for-url),
   * [page.waitForRequest(urlOrPredicate[, options])](https://jarvisbrowser.dev/docs/api/class-page#page-wait-for-request),
   * or
   * [page.waitForResponse(urlOrPredicate[, options])](https://jarvisbrowser.dev/docs/api/class-page#page-wait-for-response)
   ...
   * [browser.newContext([options])](https://jarvisbrowser.dev/docs/api/class-browser#browser-new-context). Specific
   * options like [testOptions.viewport](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-viewport) take
   * priority over this.
   *
   * **Usage**
   *
  ...
  /**
   * Default timeout for each Jarvis action in milliseconds, defaults to 0 (no timeout).
   *
   * This is a default timeout for all Jarvis actions, same as configured via
   * [page.setDefaultTimeout(timeout)](https://jarvisbrowser.dev/docs/api/class-page#page-set-default-timeout).
   *
   * **Usage**
   *
   * ```js
   ...
   * ```
   *
   * Learn more about [various timeouts](https://jarvisbrowser.dev/docs/test-timeouts).
   */
   ...
   * [page.setDefaultNavigationTimeout(timeout)](https://jarvisbrowser.dev/docs/api/class-page#page-set-default-navigation-timeout).
   *
   * **Usage**
   *
   * ```js
   ...
   *   registered.
   * - `'block'`: Jarvis will block all registration of Service Workers.
   *
   * **Usage**
   *
   * ```js
   ...
   * [page.getByTestId(testId)](https://jarvisbrowser.dev/docs/api/class-page#page-get-by-test-id). `data-testid` is used
...
/**
 * Jarvis Browser Test is based on the concept of the [test fixtures](https://jarvisbrowser.dev/docs/test-fixtures). Test fixtures are used to
 * establish environment for each test, giving the test everything it needs and nothing else.
 *
 * Jarvis Browser Test looks at each test declaration, analyses the set of fixtures the test needs and prepares those
 ...
 * ```
 *
 * Given the test above, Jarvis Browser Test will set up the `page` fixture before running the test, and tear it down
 * after the test has finished. `page` fixture provides a [Page](https://jarvisbrowser.dev/docs/api/class-page) object
 * that is available to the test.
 *
 * Jarvis Browser Test comes with builtin fixtures listed below, and you can add your own fixtures as well. Jarvis
 * Test also [provides options][TestOptions](https://jarvisbrowser.dev/docs/api/class-testoptions) to  configure
 * [fixtures.browser](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-browser),
 * [fixtures.context](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-context) and
 * [fixtures.page](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-page).
 */
export interface JarvisWorkerArgs {
  jarvis: typeof import('jarvis-browser-core');
  /**
   * [Browser](https://jarvisbrowser.dev/docs/api/class-browser) instance is shared between all tests in the
   * [same worker](https://jarvisbrowser.dev/docs/test-parallel) - this makes testing efficient. However, each test runs in an isolated
   * [BrowserContext](https://jarvisbrowser.dev/docs/api/class-browsercontext)  and gets a fresh environment.
   *
   * Learn how to [configure browser](https://jarvisbrowser.dev/docs/test-configuration) and see
   * [available options][TestOptions](https://jarvisbrowser.dev/docs/api/class-testoptions).
   *
   * **Usage**
   *
...
export interface JarvisTestArgs {
  /**
   * Isolated [BrowserContext](https://jarvisbrowser.dev/docs/api/class-browsercontext) instance, created for each test.
   * Since contexts are isolated between each other, every test gets a fresh environment, even when multiple tests run
   * in a single [Browser](https://jarvisbrowser.dev/docs/api/class-browser) for maximum efficiency.
   *
   * Learn how to [configure context](https://jarvisbrowser.dev/docs/test-configuration) and see
   * [available options][TestOptions](https://jarvisbrowser.dev/docs/api/class-testoptions).
   *
   * Default [fixtures.page](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-page) belongs to this context.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Isolated [Page](https://jarvisbrowser.dev/docs/api/class-page) instance, created for each test. Pages are isolated
   * between tests due to [fixtures.context](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-context) isolation.
   *
  ...
  page: Page;
  /**
   * Isolated [APIRequestContext](https://jarvisbrowser.dev/docs/api/class-apirequestcontext) instance for each test.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Mounts a component story and returns a [Locator](https://jarvisbrowser.dev/docs/api/class-locator) pointing to the
   ...
   * serve at [testOptions.baseURL](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-base-url). The
   * gallery exposes `window.mount(params)` and `window.unmount()` functions that render a story into its root element.
   * Each call to [fixtures.mount(storyId[, props])](https://jarvisbrowser.dev/docs/api/class-fixtures#fixtures-mount)
   * navigates to [testOptions.baseURL](https://jarvisbrowser.dev/docs/api/class-testoptions#test-options-base-url) and
...
interface AsymmetricMatchers {
   ...
   * [`constructor`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-any-option-constructor)
   * or a corresponding primitive type. Use it inside
   * [expect(value).toEqual(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-equal)
   ...
   * [`constructor`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-array-of-option-constructor)
   * or a corresponding primitive type. Use it inside
   * [expect(value).toEqual(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-equal)
   * to perform pattern matching.
   *
   ...
   * [expect(value).toBeCloseTo(expected[, numDigits])](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-be-close-to).
   *
   * **Usage**
   *
   * ```js
...
/**
 * The [GenericAssertions](https://jarvisbrowser.dev/docs/api/class-genericassertions) class provides assertion methods
 * that can be used to make assertions about any values in the tests. A new instance of
 * [GenericAssertions](https://jarvisbrowser.dev/docs/api/class-genericassertions) is created by calling
 * [expect(value)](https://jarvisbrowser.dev/docs/api/class-jarvisassertions#jarvis-assertions-expect-generic):
 *
 * ```js
 * import { test, expect } from '@jarvis-browser/test';
 *
...
interface GenericAssertions<R> {
  ...
  /**
   * Compares value with
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-be-option-expected) by
   ...
   * [expect(value).toBe(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-be)
   ...
   * performed by
   * [expect(value).toContain(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-contain-2).
   *
   ...
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-equal-option-expected),
   ...
   * matching, use
   * [expect(value).toStrictEqual(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-strict-equal).
   *
   * **Pattern matching**
   *
   * [expect(value).toEqual(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-equal)
   ...
   * matchers:
   * - [expect(value).any(constructor)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-any)
   * - [expect(value).anything()](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-anything)
   * - [expect(value).arrayContaining(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-array-containing)
   * - [expect(value).arrayOf(constructor)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-array-of)
   * - [expect(value).closeTo(expected[, numDigits])](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-close-to)
   * - [expect(value).objectContaining(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-object-containing)
   * - [expect(value).stringContaining(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-string-containing)
   * - [expect(value).stringMatching(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-string-matching)
   *
   ...
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-have-length-option-expected).
   ...
   * the
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-have-property-option-expected).
  ...
  /**
   * Compares contents of the value with contents of
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-match-object-option-expected),
  ...
  /**
   * Compares contents of the value with contents of
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-strict-equal-option-expected)
   * **and** their types.
   *
   * Differences from
   * [expect(value).toEqual(expected)](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-equal):
   ...
   * [`expected`](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-throw-option-expected).
  ...
  /**
   * An alias for
   * [expect(value).toThrow([expected])](https://jarvisbrowser.dev/docs/api/class-genericassertions#generic-assertions-to-throw).
   *
   * **Usage**
   *
   * ```js
...
/**
 * The [APIResponseAssertions](https://jarvisbrowser.dev/docs/api/class-apiresponseassertions) class provides assertion
 * methods that can be used to make assertions about the
 * [APIResponse](https://jarvisbrowser.dev/docs/api/class-apiresponse) in the tests.
 *
 * ```js
 * import { test, expect } from '@jarvis-browser/test';
 *
...
/**
 * The [LocatorAssertions](https://jarvisbrowser.dev/docs/api/class-locatorassertions) class provides assertion methods
 * that can be used to make assertions about the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) state in the
 * tests.
 *
 * ```js
 * import { test, expect } from '@jarvis-browser/test';
...
interface LocatorAssertions {
  /**
   * Ensures that [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element that is
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to a checked input.
   *
   * **Usage**
   *
   * ```js
  ...
  toBeChecked(options?: {
     ...
     * [`indeterminate`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-be-checked-option-indeterminate)
     * is set to true.
     */
    checked?: boolean;
     ...
     * [`checked`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-be-checked-option-checked)
     * is provided.
     */
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to a disabled element. Element is
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an editable element.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an empty editable element or to a
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an enabled element.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to a focused DOM node.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures that [Locator](https://jarvisbrowser.dev/docs/api/class-locator) either does not resolve to any DOM node, or
   * resolves to a [non-visible](https://jarvisbrowser.dev/docs/actionability#visible) one.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element that intersects viewport,
   * according to the
  ...
  /**
   * Ensures that [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an attached and
   * [visible](https://jarvisbrowser.dev/docs/actionability#visible) DOM node.
   *
   * To check that at least one element from the list is visible, use
   * [locator.first()](https://jarvisbrowser.dev/docs/api/class-locator#locator-first).
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with given CSS classes.
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element that contains the given
   ...
   * **Details**
   *
   * When `expected` parameter is a string, Jarvis will normalize whitespaces and line breaks both in the actual
  ...
  toContainText(expected: string|RegExp|ReadonlyArray<string|RegExp>, options?: {
     ...
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-contain-text-option-ignore-case)
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with a given
  ...
  toHaveAccessibleDescription(description: string|RegExp, options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-accessible-description-option-ignore-case)
     * option takes precedence over the corresponding regular expression flag if specified.
     */
    ignoreCase?: boolean;
  ...
  toHaveAccessibleErrorMessage(errorMessage: string|RegExp, options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-accessible-error-message-option-ignore-case)
     * option takes precedence over the corresponding regular expression flag if specified.
     */
    ignoreCase?: boolean;
  ...
  toHaveAccessibleName(name: string|RegExp, options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-accessible-name-option-ignore-case)
     * option takes precedence over the corresponding regular expression flag if specified.
     */
    ignoreCase?: boolean;
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with given attribute.
   *
   * **Usage**
   *
   * ```js
  ...
  toHaveAttribute(name: string, value: string|RegExp, options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-attribute-option-ignore-case)
     * option takes precedence over the corresponding regular expression flag if specified.
     */
    ignoreCase?: boolean;
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with given attribute. The
   ...
   * [expect(locator).toContainClass(expected[, options])](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-contain-class).
   *
   * **Usage**
   *
   * ```html
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) resolves to an exact number of DOM nodes.
   *
   * **Usage**
   *
   * ```js
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) resolves to an element with the given computed
   * CSS style.
   *
   * **Usage**
   *
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with the given DOM Node
   * ID.
   *
   * **Usage**
   *
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with given JavaScript
   ...
   * ```
   *
   * Note that screenshot assertions only work with Jarvis Browser Test runner.
  ...
  toHaveScreenshot(name: string|ReadonlyArray<string>, options?: {
     ...
     * [`maskColor`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-screenshot-1-option-mask-color))
     * that completely covers its bounding box. The mask is also applied to invisible elements, see
     * [Matching only visible elements](https://jarvisbrowser.dev/docs/locators#matching-only-visible-elements) to disable that.
     */
    mask?: Array<Locator>;
  ...
  toHaveScreenshot(options?: {
     ...
     * Specify locators that should be masked when the screenshot is taken. Masked elements will be overlaid with a pink
     * box `#FF00FF` (customized by
     * [`maskColor`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-screenshot-2-option-mask-color))
     * that completely covers its bounding box. The mask is also applied to invisible elements, see
     * [Matching only visible elements](https://jarvisbrowser.dev/docs/locators#matching-only-visible-elements) to disable that.
     */
    mask?: Array<Locator>;
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with the given text. All
  ...
  toHaveText(expected: string|RegExp|ReadonlyArray<string|RegExp>, options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-locatorassertions#locator-assertions-to-have-text-option-ignore-case)
     * option takes precedence over the corresponding regular expression flag if specified.
     */
    ignoreCase?: boolean;
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to an element with the given input
  ...
  /**
   * Ensures the [Locator](https://jarvisbrowser.dev/docs/api/class-locator) points to multi-select/combobox (i.e. a
  ...
  /**
   * Asserts that the target element matches the given [accessibility snapshot](https://jarvisbrowser.dev/docs/aria-snapshots).
   *
   * **Usage**
   *
   * ```js
...
/**
 * The [PageAssertions](https://jarvisbrowser.dev/docs/api/class-pageassertions) class provides assertion methods that
 * can be used to make assertions about the [Page](https://jarvisbrowser.dev/docs/api/class-page) state in the tests.
 *
 * ```js
 * import { test, expect } from '@jarvis-browser/test';
 *
...
interface PageAssertions {
   ...
   * [`baseURL`](https://jarvisbrowser.dev/docs/api/class-browser#browser-new-context-option-base-url) is provided via the
  ...
  toHaveURL(url: string|RegExp|URLPattern|((url: URL) => boolean), options?: {
    /**
     * Whether to perform case-insensitive match.
     * [`ignoreCase`](https://jarvisbrowser.dev/docs/api/class-pageassertions#page-assertions-to-have-url-option-ignore-case)
  ...
  /**
   * Asserts that the page body matches the given [accessibility snapshot](https://jarvisbrowser.dev/docs/aria-snapshots).
   *
   * **Usage**
   *
   * ```js
...
/**
 * Jarvis provides methods for comparing page and element screenshots with expected values stored in files.
 *
 * ```js
...
interface SnapshotAssertions {
   ...
   * ```
   *
   * Learn more about [visual comparisons](https://jarvisbrowser.dev/docs/test-snapshots).
   *
   * Note that matching snapshots only work with Jarvis Browser Test runner.
  ...
  /**
   * **NOTE** To compare screenshots, use
   * [expect(page).toHaveScreenshot([options])](https://jarvisbrowser.dev/docs/api/class-pageassertions#page-assertions-to-have-screenshot-2)
   * instead.
   *
   * Ensures that passed value, either a [string] or a [Buffer], matches the expected snapshot stored in the test
   * snapshots directory.
...
export interface TestStepInfo {
   ...
   * [`path`](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach-option-path) or
   * [`body`](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach-option-body) must be specified,
   * but not both. Calling this method will attribute the attachment to the step, as opposed to
   * [testInfo.attach(name[, options])](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-attach) which stores
   ...
   *
   * **NOTE**
   * [testStepInfo.attach(name[, options])](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach)
   * automatically takes care of copying attached files to a location that is accessible to reporters. You can safely
   * remove the attachment after awaiting the attach call.
   *
   * @param name Attachment name. The name will also be sanitized and used as the prefix of file name when saving to disk.
  ...
  attach(name: string, options?: {
    /**
     * Attachment body. Mutually exclusive with
     * [`path`](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach-option-path).
     */
    body?: string|Buffer;
     ...
     * Content type of this attachment to properly present in the report, for example `'application/json'` or
     * `'image/png'`. If omitted, content type is inferred based on the
     * [`path`](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach-option-path), or defaults to
    ...
    /**
     * Path on the filesystem to the attached file. Mutually exclusive with
     * [`body`](https://jarvisbrowser.dev/docs/api/class-teststepinfo#test-step-info-attach-option-body).
     */
    path?: string;
  }): Promise<void>;
   ...
   * [testInfo.titlePath](https://jarvisbrowser.dev/docs/api/class-testinfo#test-info-title-path).
   */
  titlePath: Array<string>;
}
 ...
 * fixtures. `WorkerInfo` is a subset of [TestInfo](https://jarvisbrowser.dev/docs/api/class-testinfo) that is available
...
export interface PageAssertionsToHaveScreenshotOptions {
   ...
   * Specify locators that should be masked when the screenshot is taken. Masked elements will be overlaid with a pink
   * box `#FF00FF` (customized by
   * [`maskColor`](https://jarvisbrowser.dev/docs/api/class-pageassertions#page-assertions-to-have-screenshot-1-option-mask-color))
   * that completely covers its bounding box. The mask is also applied to invisible elements, see
   * [Matching only visible elements](https://jarvisbrowser.dev/docs/locators#matching-only-visible-elements) to disable that.
   */
  mask?: Array<Locator>;
