...
- プロジェクト設定: `.zyraxon/skills/<name>/SKILL.md`
- グローバル設定: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
途中で、一致する `skills/*/SKILL.md` を `.zyraxon/` に読み込み、一致する `.claude/skills/*/SKILL.md` または `.agents/skills/*/SKILL.md` を読み込みます。

グローバル定義は、`~/.config/zyraxon/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md`、および `~/.agents/skills/*/SKILL.md` からもロードされます。
...
次のように `.zyraxon/skills/git-release/SKILL.md` を作成します。
