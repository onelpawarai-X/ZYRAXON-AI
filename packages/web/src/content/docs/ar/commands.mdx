...
أنشئ الملف `.zyraxon/commands/test.md`:
...
- على مستوى النظام: `~/.config/zyraxon/commands/`
- لكل مشروع: `.zyraxon/commands/`
...
يتضمن zyraxon عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
