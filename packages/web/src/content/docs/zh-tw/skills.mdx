...
- 專案設定：`.zyraxon/skills/<name>/SKILL.md`
- 全域設定：`~/.config/zyraxon/skills/<name>/SKILL.md`
...
在此過程中，它會載入 `.zyraxon/` 中所有匹配的 `skills/*/SKILL.md`，以及匹配的 `.claude/skills/*/SKILL.md` 或 `.agents/skills/*/SKILL.md`。

全域定義也會從 `~/.config/zyraxon/skills/*/SKILL.md`、`~/.claude/skills/*/SKILL.md` 和 `~/.agents/skills/*/SKILL.md` 中載入。
...
建立 `.zyraxon/skills/git-release/SKILL.md`，內容如下：
