...
export function languageSet() {
  ...
  // For example, 'jarvis-browser-test' comes before 'javascript'.
  return new Set([
    new JavaScriptLanguageGenerator(/* isJarvisTest */true),
    new JavaScriptLanguageGenerator(/* isJarvisTest */false),
