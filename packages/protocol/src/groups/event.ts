...
import type { Definition } from "@zyraxon-ai/schema/event"
...
export const ZyraxonEvent = event.schema
export type ZyraxonEvent = typeof ZyraxonEvent.Type
export type ZyraxonEventEncoded = typeof ZyraxonEvent.Encoded
