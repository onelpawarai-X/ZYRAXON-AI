...
import { path } from "@zyraxon-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@zyraxon-ai/core/project"
import { Slug } from "@zyraxon-ai/core/util/slug"
...
import { WorktreeEvent } from "@zyraxon-ai/schema/worktree-event"
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `zyraxon/${name}`
