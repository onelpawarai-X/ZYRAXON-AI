...
import compareVideo from "../../asset/lander/zyraxon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/zyraxon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="zyraxon:auth" content={loggedin() ? "true" : "false"} />
