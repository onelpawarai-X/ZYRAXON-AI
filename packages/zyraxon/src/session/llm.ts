...
import { llmClient } from "@zyraxon-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@zyraxon-ai/llm"
import { LLMClient } from "@zyraxon-ai/llm/route"
import type { LLMClientService } from "@zyraxon-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @zyraxon-ai/llm. It
