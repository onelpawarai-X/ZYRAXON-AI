...
- إعدادات المشروع: `.zyraxon/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
ويحمّل أي ملفات مطابقة لـ `skills/*/SKILL.md` داخل `.zyraxon/` وأي ملفات مطابقة لـ `.claude/skills/*/SKILL.md` أو `.agents/skills/*/SKILL.md` على طول الطريق.

كما تُحمَّل التعريفات العامة أيضاً من `~/.config/zyraxon/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
أنشئ `.zyraxon/skills/git-release/SKILL.md` بهذا الشكل:
