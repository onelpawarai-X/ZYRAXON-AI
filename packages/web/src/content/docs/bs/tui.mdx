...
Koristite `ZYRAXON_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `zyraxon.default`.
