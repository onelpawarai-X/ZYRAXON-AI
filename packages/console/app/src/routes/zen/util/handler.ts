...
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@zyraxon-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@zyraxon-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@zyraxon-ai/console-core/util/date.js"
import { Identifier } from "@zyraxon-ai/console-core/identifier.js"
import { Billing } from "@zyraxon-ai/console-core/billing.js"
import { Actor } from "@zyraxon-ai/console-core/actor.js"
import { WorkspaceTable } from "@zyraxon-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@zyraxon-ai/console-core/model.js"
import { Subscription } from "@zyraxon-ai/console-core/subscription.js"
import { BlackData } from "@zyraxon-ai/console-core/black.js"
import { UserTable } from "@zyraxon-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@zyraxon-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@zyraxon-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@zyraxon-ai/console-core/lite.js"
...
import { Workspace } from "@zyraxon-ai/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-zyraxon-session") ?? ""
    const requestId = input.request.headers.get("x-zyraxon-request") ?? ""
    const ocClient = input.request.headers.get("x-zyraxon-client") ?? ""
    const projectId = input.request.headers.get("x-zyraxon-project") ?? ""
    ...
    */
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWithRetryableStatus(
        reqUrl,
        {
          ...
          headers: (() => {
            ...
            headers.delete("x-zyraxon-request")
            headers.delete("x-zyraxon-session")
            headers.delete("x-zyraxon-project")
            headers.delete("x-zyraxon-client")
            return headers
          })(),
          body: reqBody,
      ...
      if (isNewInference) {
        const resEndpointId = res.headers.get("x-zyraxon-endpoint-id")
        const resEndpointModelId = res.headers.get("x-zyraxon-upstream-model-id")
