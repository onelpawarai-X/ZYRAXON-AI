export const dict = {
  ...
  "dialog.provider.zyraxon.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.zyraxon.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.zyraxonGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "provider.connect.zyraxonZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.zyraxonZen.visit.link": "zyraxon.ai/zen",
  "provider.connect.zyraxonZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  ...
  "wsl.onboarding.checkingZyraxon": "กำลังตรวจสอบ ZYRAXON...",
  "wsl.onboarding.checkingZyraxonIn": "กำลังตรวจสอบ ZYRAXON ใน {{distro}}...",
  "wsl.onboarding.updatingZyraxon": "กำลังอัปเดต ZYRAXON...",
  "wsl.onboarding.updatingZyraxonIn": "กำลังอัปเดต ZYRAXON ใน {{distro}}...",
  "wsl.onboarding.updateZyraxonIn": "อัปเดต ZYRAXON ใน {{distro}}.",
  "wsl.onboarding.updateZyraxon": "อัปเดต ZYRAXON",
  "wsl.onboarding.zyraxonReadyIn": "ZYRAXON พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.zyraxonReady": "ZYRAXON พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installZyraxonIn": "ติดตั้ง ZYRAXON ใน {{distro}}.",
  "wsl.onboarding.installZyraxon": "ติดตั้ง ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "ยังไม่ได้ติดตั้ง ZYRAXON",
