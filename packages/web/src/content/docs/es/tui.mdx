...
Utilice `ZYRAXON_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `zyraxon.default`.
