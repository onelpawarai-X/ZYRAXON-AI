...
- Car (18 tools) — ECU, Sensor Fusion, AEB, Lane, Parking
- Drone (15 tools) — FC, Formation, Payload, RTH
- Boat (15 tools) — MCS, DP, Radar, AIS, COLREGS
- Rocket (12 tools) — GNC, Orbit, Propulsion, Launch
- Robot (10 tools) — IK, SLAM, Force, Task
- Algorithms (10 tools) — PID, Kalman, A*, FFT
- Core Tools (68 tools) — Telemetry, Sensors, Actuators
- Systems (19 tools) — Voice, Memory, Behavior, IoT
