...
Die Modell-ID in Ihrer ZYRAXON-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [ZYRAXON Zen](/docs/zen) verwenden, würden Sie `zyraxon/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
