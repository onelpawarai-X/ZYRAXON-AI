...
As habilidades do agente permitem que o zyraxon descubra instruções reutilizáveis do seu repositório ou diretório pessoal.
...
O zyraxon pesquisa nesses locais:

- Configuração do projeto: `.zyraxon/skills/<name>/SKILL.md`
- Configuração global: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
Para caminhos locais do projeto, o zyraxon sobe a partir do seu diretório de trabalho atual até alcançar a árvore de trabalho do git.
Ele carrega qualquer `skills/*/SKILL.md` correspondente em `.zyraxon/` e qualquer `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` ao longo do caminho.

As definições globais também são carregadas de `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crie `.zyraxon/skills/git-release/SKILL.md` assim:
...
O zyraxon lista as habilidades disponíveis na descrição da ferramenta `skill`.
