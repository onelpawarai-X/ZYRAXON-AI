...
const { tools } = require('../packages/jarvis-browser-core/lib/coreBundle');
...
const fileName = path.resolve(__dirname, '../packages/jarvis-browser-core/lib/tools/cli-client/help.json');
