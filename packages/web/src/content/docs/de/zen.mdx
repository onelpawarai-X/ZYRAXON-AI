...
Die [Model-ID](/docs/config/#models) in deiner ZYRAXON-Konfiguration verwendet das Format `zyraxon/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `zyraxon/gpt-5.5` in deiner Konfiguration verwenden.
