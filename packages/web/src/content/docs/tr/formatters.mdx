...
description: zyraxon dile özgü biçimlendiriciler kullanır.
---

zyraxon, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

zyraxon, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, zyraxon bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

zyraxon bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri zyraxon yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
