...
Model-id'et i din ZYRAXON-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [ZYRAXON Zen](/docs/zen), vil du bruge `zyraxon/gpt-5.1-codex` til GPT 5.1 Codex.
