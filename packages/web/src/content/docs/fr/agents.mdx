...
L'ID de modèle dans votre configuration ZYRAXON utilise le format `provider/model-id`. Par exemple, si vous utilisez [ZYRAXON Zen](/docs/zen), vous utiliserez `zyraxon/gpt-5.1-codex` pour GPT 5.1 Codex.
