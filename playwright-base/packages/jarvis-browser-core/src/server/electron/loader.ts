...
// Always pass user arguments first, see https://github.com/zyraxon-ai/jarvis-browser/issues/16614 and
// https://github.com/zyraxon-ai/jarvis-browser/issues/29198.
...
(globalThis as any).__jarvis_run = async () => {
