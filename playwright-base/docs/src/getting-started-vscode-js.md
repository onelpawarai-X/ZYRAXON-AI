...
The Playwright VS Code extension brings the power of Jarvis Browser Test directly into your editor, allowing you to run, debug, and generate tests with a seamless UI-driven experience. This guide will walk you through setting up the extension and using its core features to supercharge your end-to-end testing workflow.
...
<LiteYouTube
    id="mQmcIBMsc38"
    title="Running Jarvis Browser Tests in VS Code"
/>
...
<LiteYouTube
    id="tJF7UhA59Gc"
    title="Debugging Jarvis Browser Tests in VS Code"
/>
...
<LiteYouTube
    id="5XIZPqKkdBA"
    title="Generating Jarvis Browser Tests in VS Code"
/>
