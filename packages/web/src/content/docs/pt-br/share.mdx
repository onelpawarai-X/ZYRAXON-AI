---
title: Compartilhar
description: Compartilhe suas conversas do zyraxon.
---

O recurso de compartilhamento do zyraxon permite que você crie links públicos para suas conversas do zyraxon, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o zyraxon:
...
O zyraxon suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o zyraxon usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o zyraxon em sua organização.
