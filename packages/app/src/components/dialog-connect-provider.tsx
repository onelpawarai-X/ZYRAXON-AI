import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@zyraxon-ai/sdk/v2/client"
...
function ProviderPicker(props: {
  ...
  const note = (id: string) => {
    ...
    if (id === "opencode-go") return language.t("dialog.provider.zyraxonGo.tagline")
    return undefined
  }
        ...
        <div class="flex flex-col gap-5 px-3 text-[13px] font-[440] leading-5 tracking-[-0.04px] text-v2-text-text-muted">
          ...
          >
            <div class="flex flex-col gap-5">
              <div>{language.t("provider.connect.zyraxonZen.line1")}</div>
              <div>{language.t("provider.connect.zyraxonZen.line2")}</div>
              <div>
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.zyraxonZen.line1")}</div>
