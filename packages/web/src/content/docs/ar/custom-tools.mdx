...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في zyraxon.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في zyraxon مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.zyraxon/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/zyraxon/tools/`.
