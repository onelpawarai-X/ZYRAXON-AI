...
import { makeGlobalNode, Node } from "@zyraxon-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<ZyraxonAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ZyraxonAssistantMessage, "role"> &
  Partial<Pick<ZyraxonAssistantMessage, "providerID" | "modelID">>
