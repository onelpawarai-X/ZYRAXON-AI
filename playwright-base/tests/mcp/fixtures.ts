...
import { chromium } from 'jarvis';

import { test as baseTest, expect as baseExpect } from '@jarvis-browser/test';
import { StdioClientTransport } from '@modelcontextprotocol/sdk/client/stdio.js';
import { Client } from '@modelcontextprotocol/sdk/client/index.js';
import { ListRootsRequestSchema } from '@modelcontextprotocol/sdk/types.js';
import { TestServer } from '../config/testserver';
import { serverFixtures } from '../config/serverFixtures';
import { tools } from '../../packages/jarvis-browser-core/lib/coreBundle';
...
import type { Config } from '../../packages/jarvis-browser-core/src/tools/mcp/config.d';
import type { BrowserContext } from 'jarvis';
...
async function createTransport(mcpServerType: TestOptions['mcpServerType'], options: { args: string[], env: NodeJS.ProcessEnv, cwd: string }): Promise<{
  ...
  const profilesDir = test.info().outputPath('ms-jarvis');
...
export const mcpServerPath = [require.resolve('../../packages/jarvis-browser-core/lib/entry/mcp.js')];
export const testMcpServerPath = [require.resolve('../../packages/jarvis-browser-test/cli.js'), 'run-test-mcp-server'];
