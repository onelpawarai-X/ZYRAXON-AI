...
export class RelayConnection {
  ...
  // Jarvis until it sees this event, so that `Target.setAutoAttach` is
  ...
  // Called when the UI adds a tab to the Jarvis group, whether as the
  ...
  // Called when the UI removes a tab from the Jarvis group. We detach the
