...
export namespace Protocol {
  ...
  export namespace Canvas {
    ...
    export type ColorSpace = "srgb"|"srgb-linear"|"display-p3"|"display-p3-linear";
    /**
...
(default: 0).
  ...
  export namespace Jarvis {
    ...
    export type createContextParameters = {
      ...
      /**
       * Wether to use storage partitioning. Be default Jarvis disables the partitioning.
       */
  ...
  export type Events = {
    ...
    "Jarvis.pageProxyCreated": Jarvis.pageProxyCreatedPayload;
    "Jarvis.pageProxyDestroyed": Jarvis.pageProxyDestroyedPayload;
    "Jarvis.provisionalLoadFailed": Jarvis.provisionalLoadFailedPayload;
    "Jarvis.windowOpen": Jarvis.windowOpenPayload;
    "Jarvis.downloadCreated": Jarvis.downloadCreatedPayload;
    "Jarvis.downloadFilenameSuggested": Jarvis.downloadFilenameSuggestedPayload;
    "Jarvis.downloadFinished": Jarvis.downloadFinishedPayload;
  ...
  export interface CommandParameters {
    ...
    "Jarvis.enable": Jarvis.enableParameters;
    "Jarvis.disable": Jarvis.disableParameters;
    "Jarvis.getInfo": Jarvis.getInfoParameters;
    "Jarvis.close": Jarvis.closeParameters;
    "Jarvis.createContext": Jarvis.createContextParameters;
    "Jarvis.deleteContext": Jarvis.deleteContextParameters;
    "Jarvis.createPage": Jarvis.createPageParameters;
    "Jarvis.navigate": Jarvis.navigateParameters;
    "Jarvis.grantFileReadAccess": Jarvis.grantFileReadAccessParameters;
    "Jarvis.takePageScreenshot": Jarvis.takePageScreenshotParameters;
    "Jarvis.setIgnoreCertificateErrors": Jarvis.setIgnoreCertificateErrorsParameters;
    "Jarvis.setPageZoomFactor": Jarvis.setPageZoomFactorParameters;
    "Jarvis.closePage": Jarvis.closePageParameters;
    "Jarvis.getAllCookies": Jarvis.getAllCookiesParameters;
    "Jarvis.setCookies": Jarvis.setCookiesParameters;
    "Jarvis.deleteAllCookies": Jarvis.deleteAllCookiesParameters;
    "Jarvis.setGeolocationOverride": Jarvis.setGeolocationOverrideParameters;
    "Jarvis.setLanguages": Jarvis.setLanguagesParameters;
    "Jarvis.setDownloadBehavior": Jarvis.setDownloadBehaviorParameters;
    "Jarvis.cancelDownload": Jarvis.cancelDownloadParameters;
    "Jarvis.clearMemoryCache": Jarvis.clearMemoryCacheParameters;
  ...
  export interface CommandReturnValues {
    ...
    "Jarvis.enable": Jarvis.enableReturnValue;
    "Jarvis.disable": Jarvis.disableReturnValue;
    "Jarvis.getInfo": Jarvis.getInfoReturnValue;
    "Jarvis.close": Jarvis.closeReturnValue;
    "Jarvis.createContext": Jarvis.createContextReturnValue;
    "Jarvis.deleteContext": Jarvis.deleteContextReturnValue;
    "Jarvis.createPage": Jarvis.createPageReturnValue;
    "Jarvis.navigate": Jarvis.navigateReturnValue;
    "Jarvis.grantFileReadAccess": Jarvis.grantFileReadAccessReturnValue;
    "Jarvis.takePageScreenshot": Jarvis.takePageScreenshotReturnValue;
    "Jarvis.setIgnoreCertificateErrors": Jarvis.setIgnoreCertificateErrorsReturnValue;
    "Jarvis.setPageZoomFactor": Jarvis.setPageZoomFactorReturnValue;
    "Jarvis.closePage": Jarvis.closePageReturnValue;
    "Jarvis.getAllCookies": Jarvis.getAllCookiesReturnValue;
    "Jarvis.setCookies": Jarvis.setCookiesReturnValue;
    "Jarvis.deleteAllCookies": Jarvis.deleteAllCookiesReturnValue;
    "Jarvis.setGeolocationOverride": Jarvis.setGeolocationOverrideReturnValue;
    "Jarvis.setLanguages": Jarvis.setLanguagesReturnValue;
    "Jarvis.setDownloadBehavior": Jarvis.setDownloadBehaviorReturnValue;
    "Jarvis.cancelDownload": Jarvis.cancelDownloadReturnValue;
    "Jarvis.clearMemoryCache": Jarvis.clearMemoryCacheReturnValue;
