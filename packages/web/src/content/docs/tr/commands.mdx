...
`.zyraxon/commands/test.md` oluştur:
...
zyraxon işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

zyraxon [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/zyraxon/commands/`
- Proje başına: `.zyraxon/commands/`
...
zyraxon, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
