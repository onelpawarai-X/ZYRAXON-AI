...
import type * as channels from '../../packages/jarvis-browser-core/src/client/channels';
...
export class Backend extends EventEmitter {
  ...
  async initialize() {
    await this.channel.initialize({ codegenId: 'jarvis-browser-test', sdkLanguage: 'javascript' }, undefined);
  }
