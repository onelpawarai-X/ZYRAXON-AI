...
O [model id](/docs/config/#models) na sua configuração do ZYRAXON usa o formato `zyraxon/<model-id>`. Por exemplo, para GPT 5.5, você usaria `zyraxon/gpt-5.5` na sua configuração.
