...
import type { Data, Definition, Payload } from "@zyraxon-ai/schema/event"
...
import { Durable } from "@zyraxon-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@zyraxon-ai/schema/event").ID
export type { Data, Definition, Payload } from "@zyraxon-ai/schema/event"
