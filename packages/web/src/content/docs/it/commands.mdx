...
- Globale: `~/.config/zyraxon/commands/`
- Per progetto: `.zyraxon/commands/`
...
zyraxon include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
