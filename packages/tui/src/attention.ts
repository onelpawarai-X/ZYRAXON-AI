...
} from "@zyraxon-ai/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@zyraxon-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@zyraxon-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@zyraxon-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@zyraxon-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@zyraxon-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@zyraxon-ai/ui/audio/yup-01.mp3" with { type: "file" }
