...
Som standard bruker ZYRAXON vårt eget `zyraxon`-tema.
...
2. **Brukerkonfigurasjonskatalog** - Definert i `~/.config/zyraxon/themes/*.json` eller `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.zyraxon/themes/*.json`
4. **Gjeldende arbeidskatalog** - Definert i `./.zyraxon/themes/*.json`
