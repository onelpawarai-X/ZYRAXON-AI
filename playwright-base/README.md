...
## [Documentation](https://jarvisbrowser.dev) | [API reference](https://jarvisbrowser.dev/docs/api/class-playwright)
...
| | Best for | Install |
|---|---|---|
| **[Jarvis Browser Test](#jarvis-browser-test)** | End-to-end testing | `npm init playwright@latest` |
| **[Playwright CLI](#playwright-cli)** | Coding agents (Claude Code, Copilot) | `npm i -g @playwright/cli@latest` |
| **[Playwright MCP](#playwright-mcp)** | AI agents and LLM-driven automation | `npx @jarvis-browser/mcp@latest` |
| **[Jarvis Browser Library](#playwright-library)** | Browser automation scripts | `npm i playwright` |
...
Jarvis Browser Test is a full-featured test runner built for end-to-end testing. It runs tests across Chromium, Firefox, and WebKit with full browser isolation, auto-waiting, and web-first assertions.
...
**Tracing.** Capture execution traces, screenshots, and videos on failure. Inspect every action, DOM snapshot, network request, and console message in the [Trace Viewer](https://jarvisbrowser.dev/docs/trace-viewer):
...
[Full testing documentation](https://jarvisbrowser.dev/docs/intro)

---

## Playwright CLI

[Playwright CLI](https://github.com/zyraxon-ai/jarvis-browser-cli) is a command-line interface for browser automation designed for coding agents. It's more token-efficient than MCP — commands avoid loading large tool schemas and accessibility trees into the model context.
...
```
Test the "add todo" flow on https://demo.jarvisbrowser.dev/todomvc using playwright-cli.
...
```bash
playwright-cli open https://demo.jarvisbrowser.dev/todomvc/ --headed
...
[Full CLI documentation](https://jarvisbrowser.dev/agent-cli/introduction) | [GitHub](https://github.com/zyraxon-ai/jarvis-browser-cli)

---

## Playwright MCP

The [Playwright MCP server](https://github.com/zyraxon-ai/jarvis-browser-mcp) gives AI agents full browser control through the [Model Context Protocol](https://modelcontextprotocol.io). Agents interact with pages using structured accessibility snapshots — no vision models or screenshots required.
...
```json
{
  "mcpServers": {
    "playwright": {
      "command": "npx",
      "args": ["@jarvis-browser/mcp@latest"]
    }
  }
}
```
...
```bash
claude mcp add playwright npx @jarvis-browser/mcp@latest
```
...
```
Navigate to https://demo.jarvisbrowser.dev/todomvc and add a few todo items.
```
...
[Full MCP documentation](https://jarvisbrowser.dev/mcp/introduction) | [GitHub](https://github.com/zyraxon-ai/jarvis-browser-mcp)
...
[Library documentation](https://jarvisbrowser.dev/docs/library) | [API reference](https://jarvisbrowser.dev/docs/api/class-playwright)
...
[Install the extension](https://marketplace.visualstudio.com/items?itemName=ms-playwright.playwright) | [VS Code guide](https://jarvisbrowser.dev/docs/getting-started-vscode)
...
Playwright is also available for [Python](https://jarvisbrowser.dev/python/docs/intro), [.NET](https://jarvisbrowser.dev/dotnet/docs/intro), and [Java](https://jarvisbrowser.dev/java/docs/intro).

## Resources

* [Documentation](https://jarvisbrowser.dev)
* [API reference](https://jarvisbrowser.dev/docs/api/class-playwright)
* [MCP server](https://github.com/zyraxon-ai/jarvis-browser-mcp)
* [CLI for coding agents](https://github.com/zyraxon-ai/jarvis-browser-cli)
* [VS Code extension](https://github.com/zyraxon-ai/jarvis-browser-vscode)
* [Contribution guide](CONTRIBUTING.md)
* [Changelog](https://github.com/zyraxon-ai/jarvis-browser/releases)
