---
title: LSP-servere
description: zyraxon integreres med LSP-serverne dine.
---
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `ZYRAXON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og zyraxon åpner en fil, gjør den:
