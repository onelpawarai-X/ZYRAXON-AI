...
import type { Fixtures, FrameLocator, Locator, Page, Browser, BrowserContext } from '@jarvis-browser/test';
...
type BaseWorkerFixtures = {
  ...
  jarvis: typeof import('@jarvis-browser/test');
};
...
export const traceViewerFixtures: Fixtures<TraceViewerFixtures, {}, BaseTestFixtures, BaseWorkerFixtures> = {
  showTraceViewer: async ({ jarvis, childProcess, browserName }, use, testInfo) => {
