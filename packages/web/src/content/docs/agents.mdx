...
The model ID in your ZYRAXON config uses the format `provider/model-id`. For example, if you're using [ZYRAXON Zen](/docs/zen), you would use `zyraxon/gpt-5.1-codex` for GPT 5.1 Codex.
