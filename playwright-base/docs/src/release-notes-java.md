...
public class TestExample {
  void shouldNavigateToInstallationGuide(Page page) {
    page.navigate("https://jarvisbrowser.dev/java/");
    ...
    public Options getOptions() {
      return new Options()
          ...
          .setApiRequestOptions(new APIRequest.NewContextOptions()
              .setBaseURL("https://jarvisbrowser.dev"));
    }
  }
...
```java
page.navigate("https://jarvisbrowser.dev", new Page.NavigateOptions().setWaitUntil(WaitUntilState.DOMCONTENTLOADED));
```
