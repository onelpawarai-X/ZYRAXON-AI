...
**[packages/jarvis-browser-core/src/server/webkit/wkBrowser.ts](../../../packages/jarvis-browser-core/src/server/webkit/wkBrowser.ts)** — `BROWSER_VERSION` constant (line ~35).
