---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor zyraxon.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK zyraxon JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar zyraxon mediante programación.
...
Si ya tiene una instancia en ejecución de zyraxon, puede crear una instancia de cliente para conectarse a ella:
