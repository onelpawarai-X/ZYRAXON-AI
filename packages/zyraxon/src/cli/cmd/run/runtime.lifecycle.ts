...
import { openEditor } from "@zyraxon-ai/tui/editor"
import { registerZyraxonKeymap } from "@zyraxon-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerZyraxonKeymap(keymap, renderer, input.tuiConfig)
