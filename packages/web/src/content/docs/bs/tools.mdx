...
:::note
Ovaj alat je dostupan samo kada je `ZYRAXON_EXPERIMENTAL_LSP_TOOL=true` (ili `ZYRAXON_EXPERIMENTAL=true`).
:::
...
:::note
Ovaj alat je dostupan samo uz ZYRAXON provajdera ili kada je varijabla `ZYRAXON_ENABLE_EXA` postavljena na truthy vrijednost (npr. `true` ili `1`).
