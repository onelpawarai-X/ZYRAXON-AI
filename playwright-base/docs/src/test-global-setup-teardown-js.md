...
import { test as teardown } from '@jarvis-browser/test';
...
import { chromium, type FullConfig } from '@jarvis-browser/test';
...
```js title="global-setup.ts"
import type { FullConfig } from '@jarvis-browser/test';
