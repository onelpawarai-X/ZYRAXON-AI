export const dict = {
  ...
  "dialog.provider.zyraxon.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.zyraxon.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.zyraxonGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.zyraxonZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.zyraxonZen.visit.prefix": "다음 ",
  "provider.connect.zyraxonZen.visit.link": "zyraxon.ai/zen",
  "provider.connect.zyraxonZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "wsl.onboarding.checkingZyraxon": "ZYRAXON 확인 중...",
  "wsl.onboarding.checkingZyraxonIn": "{{distro}}에서 ZYRAXON 확인 중...",
  "wsl.onboarding.updatingZyraxon": "ZYRAXON 업데이트 중...",
  "wsl.onboarding.updatingZyraxonIn": "{{distro}}에서 ZYRAXON 업데이트 중...",
  "wsl.onboarding.updateZyraxonIn": "{{distro}}에서 ZYRAXON를 업데이트하세요.",
  "wsl.onboarding.updateZyraxon": "ZYRAXON 업데이트",
  "wsl.onboarding.zyraxonReadyIn": "{{distro}}에서 ZYRAXON를 사용할 준비가 되었습니다.",
  "wsl.onboarding.zyraxonReady": "ZYRAXON가 준비되었습니다.",
  "wsl.onboarding.installZyraxonIn": "{{distro}}에 ZYRAXON를 설치하세요.",
  "wsl.onboarding.installZyraxon": "ZYRAXON 설치",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "ZYRAXON가 설치되지 않음",
