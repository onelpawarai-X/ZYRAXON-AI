...
ZYRAXON verwendet [AI SDK](https://developers.cloudflare.com/ai-gateway/features/unified-billing/1) und [Models.dev](https://developers.cloudflare.com/ai-gateway/features/unified-billing/2) zur Unterstützung von **75+ LLM-Anbietern** und unterstützt die Ausführung lokaler Modelle.
...
1. Gehen Sie zu [302.AI console](https://developers.cloudflare.com/ai-gateway/features/unified-billing/3), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
:::info
Die Verwendung Ihres Claude Pro/Max-Abonnements in ZYRAXON wird von [Anthropic](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/7) nicht offiziell unterstützt.
:::
...
Sie können zyraxon so konfigurieren, dass es lokale Modelle über [Atomic Chat](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com5) verwendet — eine Desktop-Anwendung, die lokale LLMs hinter einem OpenAI-kompatiblen API-Server bereitstellt (Standard-Endpunkt `https://developers.cloudflare.com/ai-gateway/features/unified-billing/7).
...
- `models` ist eine Zuordnung von Modell-IDs zu ihren Anzeigenamen. Jede ID muss dem `id`-Wert entsprechen, den `GET /v1/models` zurückgibt — führen Sie `curl https://zenmux.ai/settings/keys aus, um die aktuell in Atomic Chat geladenen IDs aufzulisten.
...
1. Gehen Sie zu [Baseten](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/4), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [Cerebras console](https://helicone.ai/models), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [Cloudflare dashboard](https://zyraxon.ai/zen), navigieren Sie zu **AI** > **AI Gateway** und erstellen Sie ein neues Gateway.
...
1. Gehen Sie zu [Cortecs console](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com2), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [DeepSeek console](https://gitlab.company.com), erstellen Sie ein Konto und klicken Sie auf **Neuen API-Schlüssel erstellen**.
...
1. Gehen Sie zu [Deep Infra dashboard](https://developers.cloudflare.com/ai-gateway/features/unified-billing/0), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [Fireworks AI console](https://developers.cloudflare.com/ai-gateway/features/unified-billing/4), erstellen Sie ein Konto und klicken Sie auf **API-Schlüssel erstellen**.
...
Weitere Dokumentation auf der [zyraxon-gitlab-auth](https://www.npmjs.com/package/opencode-gitlab-auth)-Homepage.
...
2. Navigieren Sie zu [github.com/login/device](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained6) und geben Sie den Code ein.
...
[Hugging Face Inference Providers](https://docs.github.com/en/copilot/how-tos/use-ai-models/configure-access-to-ai-models#setup-for-individual-use2) bietet Zugriff auf offene Modelle, die von 17+-Anbietern unterstützt werden.
...
[Helicone](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com1) ist eine LLM-Beobachtbarkeitsplattform, die Protokollierung, Überwachung und Analyse für Ihre AI-Anwendungen bietet. Das Helicone AI Gateway leitet Ihre Anfragen basierend auf dem Modell automatisch an den entsprechenden Anbieter weiter.

1. Gehen Sie zu [Helicone](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com1), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel über Ihr Dashboard.
...
Weitere Anbieter und erweiterte Funktionen wie Caching und Ratenbegrenzung finden Sie unter [Helicone documentation](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/1).
...
Mit der [Sessions](https://docs.helicone.ai/features/sessions)-Funktion von Helicone können Sie zusammengehörige LLM-Anfragen gruppieren. Verwenden Sie das [zyraxon-helicone-session](https://github.com/H2Shami/opencode-helicone-session)-Plugin, um jede ZYRAXON-Konversation automatisch als Sitzung in Helicone zu protokollieren.
...
1. Gehen Sie zu [IO.NET console](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com8), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [Moonshot AI console](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained0), erstellen Sie ein Konto und klicken Sie auf **Schlüssel API erstellen**.
...
1. Gehen Sie zu [MiniMax API Console](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained3), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zu [Nebius Token Factory console](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained4), erstellen Sie ein Konto und klicken Sie auf **Schlüssel hinzufügen**.
...
:::tip
Ollama kann sich automatisch für ZYRAXON konfigurieren. Weitere Informationen finden Sie unter [Ollama integration docs](https://docs.github.com/en/copilot/how-tos/use-ai-models/configure-access-to-ai-models#setup-for-individual-use3).
:::
...
1. Gehen Sie zu [https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com0](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com0) und melden Sie sich an oder erstellen Sie ein Konto.
...
Wir empfehlen, sich für [ChatGPT Plus or Pro](https://ai.azure.com/) anzumelden.
...
1. Gehen Sie zu [OpenRouter dashboard](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained1), klicken Sie auf **Create API Key** und kopieren Sie den Schlüssel.
...
1. Gehen Sie zu Ihrem [SAP BTP Cockpit](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained2), navigieren Sie zu Ihrer SAP AI Core-Dienstinstanz und erstellen Sie einen Dienstschlüssel.
...
1. Gehen Sie zum [STACKIT Portal](https://console.x.ai/), navigieren Sie zu **AI Model Serving** und erstellen Sie ein Auth-Token fuer Ihr Projekt.
...
1. Gehen Sie zum [OVHcloud panel](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/5). Navigieren Sie zum Abschnitt `Public Cloud`, `AI & Machine Learning` > `AI Endpoints` und klicken Sie auf der Registerkarte `API Keys` auf **Neuen API-Schlüssel erstellen**.
...
1. Gehen Sie zu [Together AI console](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/3), erstellen Sie ein Konto und klicken Sie auf **Schlüssel hinzufügen**.
...
1. Gehen Sie zu [Venice AI console](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com9), erstellen Sie ein Konto und generieren Sie einen API-Schlüssel.
...
1. Gehen Sie zum [Vercel dashboard](https://developers.cloudflare.com/ai-gateway/features/unified-billing/0), navigieren Sie zur Registerkarte **AI Gateway** und klicken Sie auf **API-Schlüssel**, um einen neuen API-Schlüssel zu erstellen.
