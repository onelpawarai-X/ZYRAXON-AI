---
title: SDK
description: Типобезопасный JS-клиент для сервера zyraxon.
---
...
Если у вас уже есть работающий экземпляр zyraxon, вы можете создать экземпляр клиента для подключения к нему:
