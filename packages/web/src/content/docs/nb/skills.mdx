...
- Prosjektkonfigurasjon: `.zyraxon/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
For prosjektlokale stier går zyraxon opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.zyraxon/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.zyraxon/skills/git-release/SKILL.md` slik:
...
zyraxon viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
