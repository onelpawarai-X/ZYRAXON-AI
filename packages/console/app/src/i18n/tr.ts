...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | zyraxon",
  ...
  "temp.screenshot.alt": "tokyonight temalı zyraxon TUI",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman zyraxon ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve zyraxon seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "zyraxon'u başlatın ve çalıştırın",
  ...
  "workspace.keys.empty": "Bir zyraxon Gateway API anahtarı oluşturun",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için zyraxon yapılandırmanızda "ZYRAXON Go"\'yu sağlayıcı olarak seçin.',
