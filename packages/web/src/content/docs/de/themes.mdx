...
Standardmaessig verwendet ZYRAXON das `zyraxon`-Theme.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/zyraxon/themes/*.json` oder `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.zyraxon/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.zyraxon/themes/*.json`
