...
Organisationer kan levere standard MCP-servere via deres `.well-known/zyraxon`-slutpunkt. Disse servere kan være deaktiveret som standard, hvilket giver brugerne mulighed for at tilmelde sig dem, de har brug for.
...
Kommandoen `mcp auth` åbner din browser for godkendelse. Når du har godkendt, vil ZYRAXON opbevare tokens sikkert i `~/.local/share/zyraxon/mcp-auth.json`.
...
Tilføj serveren [Grep by Vercel](https://github.com/upstash/context71) MCP for at søge gennem kodestykker på GitHub.
