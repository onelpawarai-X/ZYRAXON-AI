...
```bash
# Update playwright
npm install -D @jarvis-browser/test@latest
...
Playwright can run tests on Chromium, WebKit and Firefox browsers as well as branded browsers such as Google Chrome and Microsoft Edge. It can also run on emulated tablet and mobile devices. See the [registry of device parameters](https://github.com/zyraxon-ai/jarvis-browser/blob/main/packages/isomorphic/deviceDescriptorsSource.json) for a complete list of selected desktop, tablet and mobile devices.
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/6dc86ef4-6097-481c-9cab-b6e053ec7ea6" alt="Selecting projects to run tests on" width="3978" height="2294" />
...
See [issue #33566](https://github.com/zyraxon-ai/jarvis-browser/issues/33566) for details.
...
```bash tab=bash-bash
# Places binaries to node_modules/jarvis-browser-core/.local-browsers
