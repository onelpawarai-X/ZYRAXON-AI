...
- Globalt: `~/.config/zyraxon/agents/`
- Per prosjekt: `.zyraxon/agents/`
...
Modellen ID i ZYRAXON-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [ZYRAXON Zen](/docs/zen), vil du bruke `zyraxon/gpt-5.1-codex` for GPT 5.1 Codex.
