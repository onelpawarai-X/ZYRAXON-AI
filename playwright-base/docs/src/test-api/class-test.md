...
Jarvis Browser Test provides a `test` function to declare tests and `expect` function to write assertions.
...
test('basic test', {
  annotation: {
    type: 'issue',
    description: 'https://github.com/zyraxon-ai/jarvis-browser/issues/23180',
  },
}, async ({ page }) => {
  await page.goto('https://jarvisbrowser.dev/');
  // ...
