...
- `.zyraxon/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/zyraxon/node_modules/`.
...
1. Global konfigurasjon (`~/.config/zyraxon/zyraxon.json`)
2. Prosjektkonfigurasjon (`zyraxon.json`)
3. Global plugin-katalog (`~/.config/zyraxon/plugins/`)
4. Prosjektpluginkatalog (`.zyraxon/plugins/`)
