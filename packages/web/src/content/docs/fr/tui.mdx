...
Utilisez `ZYRAXON_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `zyraxon.default`.
