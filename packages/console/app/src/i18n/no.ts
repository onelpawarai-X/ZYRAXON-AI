...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | zyraxon",
  ...
  "temp.feature.zen.afterLink": "levert av zyraxon",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med zyraxon når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg zyraxon",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start zyraxon og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til zyraxon-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en zyraxon Gateway API-nøkkel",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "ZYRAXON Go" som leverandør i zyraxon-konfigurasjonen din for å bruke Go-modeller.',
