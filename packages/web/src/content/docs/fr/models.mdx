...
Ici, l'identifiant complet est `provider_id/model_id`. Par exemple, si vous utilisez [ZYRAXON Zen](/docs/zen), vous utiliserez `zyraxon/gpt-5.1-codex` pour GPT 5.1 Codex.
