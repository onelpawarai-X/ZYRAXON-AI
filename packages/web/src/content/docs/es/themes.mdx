...
De forma predeterminada, ZYRAXON usa nuestro propio tema `zyraxon`.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/zyraxon/themes/*.json` o `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.zyraxon/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.zyraxon/themes/*.json`
