---
title: TUI
description: Bruke zyraxon-terminalbrukergrensesnittet.
---
...
Bruk `ZYRAXON_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `zyraxon.default`.
