...
const annotate = defineTabTool({
  ...
  schema: {
    ...
    description: 'Open the Jarvis Dashboard in annotation mode for the current page and wait for the user to draw annotations. Returns the annotated screenshot, ARIA snapshot, and the list of annotations.',
    inputSchema: z.object({}),
    type: 'readOnly',
  },
