...
export type Config = {
  ...
  browser?: {
     ...
     * @see https://jarvisbrowser.dev/docs/api/class-browsertype#browser-type-launch-persistent-context
     *
     * This is useful for settings options like `channel`, `headless`, `executablePath`, etc.
     */
    launchOptions?: jarvis.LaunchOptions;
     ...
     */
    contextOptions?: jarvis.BrowserContextOptions;
    ...
    /**
     * Remote endpoint to connect to an existing Jarvis server. May be a
     ...
     */
    remoteEndpoint?: string | jarvis.ConnectOptions & { endpoint: string };

    /**
     * Paths to TypeScript files to add as initialization scripts for Jarvis page.
     */
    initPage?: string[];
   ...
   * config is ignored.
   * Requires the "Jarvis Extension" to be installed.
   */
  extension?: boolean;
  ...
  /**
   * Whether to save the Jarvis session into the output directory.
   */
  saveSession?: boolean;
  ...
  timeouts?: {
    /*
     * Configures default action timeout: https://jarvisbrowser.dev/docs/api/class-page#page-set-default-timeout. Defaults to 5000ms.
     */
    action?: number;

    /*
     * Configures default navigation timeout: https://jarvisbrowser.dev/docs/api/class-page#page-set-default-navigation-timeout. Defaults to 60000ms.
     */
    navigation?: number;

    /**
     * Configures default expect timeout: https://jarvisbrowser.dev/docs/test-timeouts#expect-timeout. Defaults to 5000ms.
     */
    expect?: number;
