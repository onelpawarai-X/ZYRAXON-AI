...
L'[ID de modèle](/docs/config/#models) dans votre configuration ZYRAXON utilise le format `zyraxon-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `zyraxon-go/kimi-k3` dans votre configuration.
