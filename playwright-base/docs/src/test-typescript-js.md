...
Sometimes, Jarvis Browser Test will not be able to transform your TypeScript code correctly, for example when you are using experimental or very recent features of TypeScript, usually configured in `tsconfig.json`.
...
```json
{
  "scripts": {
    ...
    "test": "Jarvis Browser Test -c tests-out"
  }
}
```
