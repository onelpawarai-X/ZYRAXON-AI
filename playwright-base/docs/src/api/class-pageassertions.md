...
```python sync
page.goto("https://demo.jarvisbrowser.dev/todomvc/")
...
```csharp
await page.GotoAsync("https://demo.jarvisbrowser.dev/todomvc/");
...
```java
page.navigate("https://demo.jarvisbrowser.dev/todomvc/");
...
```js
// Check for the page URL to be 'https://jarvisbrowser.dev/docs/intro' (including query string)
await expect(page).toHaveURL('https://jarvisbrowser.dev/docs/intro');
