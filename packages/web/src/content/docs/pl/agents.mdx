...
- Globalnie: `~/.config/zyraxon/agents/`
- W projekcie: `.zyraxon/agents/`
...
Identyfikator modelu jest taki sam, jak w konfiguracji ZYRAXON w `provider/model-id`. Na przykład, [ZYRAXON Zen](/docs/zen), użyj `zyraxon/gpt-5.1-codex` dla GPT 5.1 Codex.
