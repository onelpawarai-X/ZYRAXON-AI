...
import { SessionInput } from "@zyraxon-ai/schema/session-input"
import { PromptInput } from "@zyraxon-ai/schema/prompt-input"
import { Session } from "@zyraxon-ai/schema/session"
import { Project } from "@zyraxon-ai/schema/project"
import { AbsolutePath, NonNegativeInt, PositiveInt, RelativePath, statics } from "@zyraxon-ai/schema/schema"
...
import { Agent } from "@zyraxon-ai/schema/agent"
...
import { SessionEvent } from "@zyraxon-ai/schema/session-event"
      ...
      HttpApiEndpoint.post("session.interrupt", "/api/session/:sessionID/interrupt", {
        ...
        .annotateMerge(
          OpenApi.annotations({
            ...
            description: "Interrupt active execution owned by this Zyraxon process. Idle interruption is a no-op.",
          }),
        ),
    )
    .add(
