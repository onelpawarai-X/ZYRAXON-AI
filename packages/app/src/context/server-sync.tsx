...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ZyraxonClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: ZyraxonClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ZyraxonClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => ZyraxonClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ZyraxonClient>()
