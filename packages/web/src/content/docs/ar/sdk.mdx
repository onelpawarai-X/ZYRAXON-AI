...
description: عميل JavaScript آمن الأنواع لخادم zyraxon.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ zyraxon لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في zyraxon برمجيا.
...
إذا كان لديك مثيل zyraxon يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
