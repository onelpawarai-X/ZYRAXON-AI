...
export function getUserAgent(): string {
  ...
  try {
    ...
    cachedUserAgent = 'Jarvis/unknown';
  }
  return cachedUserAgent;
}
...
function determineUserAgent(): string {
  ...
  return `Jarvis/${getJarvisVersion()} (${os.arch()}; ${osIdentifier} ${osVersion}) ${embedderName}/${embedderVersion}${serializedTokens}`;
}
...
export function getJarvisVersion(majorMinorOnly = false): string {
