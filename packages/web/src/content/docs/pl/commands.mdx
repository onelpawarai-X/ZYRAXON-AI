...
Utwórz `.zyraxon/commands/test.md`:
...
Użyj opcji `command` w swojej konfiguracji zyraxon:
...
- Globalnie: `~/.config/zyraxon/commands/`
- Na projekt: `.zyraxon/commands/`
...
zyraxon zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
