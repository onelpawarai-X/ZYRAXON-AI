...
const rule = createRule({
  ...
  meta: {
    ...
    messages: {
      missingProgress: 'Awaited async call must either pass `progress` as first argument or be wrapped in `progress.race()`. See packages/jarvis-browser-core/src/server/progress.ts.',
    },
    schema: [],
  },
  defaultOptions: [],
