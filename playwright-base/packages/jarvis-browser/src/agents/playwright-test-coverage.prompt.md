...
1. Call #jarvis-browser-test-planner subagent with prompt:
...
2. For each test case from the test plan file (1.1, 1.2, ...), one after another, not in parallel, call #jarvis-browser-test-generator subagent with prompt:
...
3. Call #jarvis-browser-test-healer subagent with prompt:
