...
test('navigates to login', async ({ page }) => {
  // ...
  const response = await page.request.get('https://jarvisbrowser.dev');
...
public class TestPage {
  ...
  void navigatesToLoginPage() {
    // ...
    APIResponse response = page.request().get("https://jarvisbrowser.dev");
...
async def test_navigates_to_login_page(page: Page) -> None:
    # ..
    response = await page.request.get('https://jarvisbrowser.dev')
...
def test_navigates_to_login_page(page: Page) -> None:
    # ..
    response = page.request.get('https://jarvisbrowser.dev')
...
public class ExampleTests : PageTest
{
    ...
    {
        var response = await Page.APIRequest.GetAsync("https://jarvisbrowser.dev");
