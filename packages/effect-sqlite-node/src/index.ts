...
export const TypeId: TypeId = "~@zyraxon-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@zyraxon-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@zyraxon-ai/effect-sqlite-node/NodeSqliteClient")
