...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | zyraxon",
  ...
  "temp.feature.zen.afterLink": "leveret af zyraxon",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med zyraxon, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg zyraxon",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start zyraxon og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til zyraxon-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en zyraxon Gateway API-nøgle",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "ZYRAXON Go" som udbyder i din zyraxon-konfiguration for at bruge Go-modeller.',
