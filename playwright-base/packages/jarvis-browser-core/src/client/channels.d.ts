...
export type InitializerTraits<T> =
    ...
    T extends JarvisChannel ? JarvisInitializer :
...
export type EventsTraits<T> =
    ...
    T extends JarvisChannel ? JarvisEvents :
...
export type EventTargetTraits<T> =
    ...
    T extends JarvisChannel ? JarvisEventTarget :
...
export interface BrowserContextEventTarget {
  ...
  on(event: 'dialogClosed', callback: (params: BrowserContextDialogClosedEvent) => void): this;
...
export interface JarvisEventTarget {
}
export interface JarvisChannel extends JarvisEventTarget, Channel {
  _type_Jarvis: boolean;
  newRequest(params: JarvisNewRequestParams, options: TimeoutOptions): Promise<JarvisNewRequestResult>;
}
export type JarvisNewRequestParams = {
  baseURL?: string,
  userAgent?: string,
  ignoreHTTPSErrors?: boolean,
  extraHTTPHeaders?: NameValue[],
...
export type JarvisNewRequestOptions = {
  baseURL?: string,
  userAgent?: string,
  ignoreHTTPSErrors?: boolean,
  extraHTTPHeaders?: NameValue[],
...
export type JarvisNewRequestResult = {
