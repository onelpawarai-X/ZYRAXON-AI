import zyraxonWordmarkDark from "../asset/logo-ornate-dark.svg"
      ...
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://zyraxon.ai/">
            <strong>{i18n.t("header.tryZYRAXON")}</strong>
          </a>
          <button
...
function ZyraxonMark() {
  return (
    <svg data-slot="zyraxon-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const connect = [
    ...
    { href: "https://x.com/SayidiLxs", label: "X" },
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={zyraxonWordmarkDark} alt="ZYRAXON" />
          <button
