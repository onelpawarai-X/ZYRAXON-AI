...
usa il formato `zyraxon/<model-id>`. Per esempio, per GPT 5.5, useresti
`zyraxon/gpt-5.5` nella tua config.
...
- North Mini Code Free: Durante il periodo gratuito, i dati raccolti possono essere conservati e utilizzati per migliorare il modello. Non inviare dati personali o riservati. Consulta i nostri [Termini di utilizzo](https://cohere.com/terms-of-use) e la nostra [Informativa sulla privacy](https://docs.anthropic.com/en/docs/claude-code/data-usage1).
