...
- Globale: `~/.config/zyraxon/agents/`
- Per progetto: `.zyraxon/agents/`
...
L'ID modello nella configurazione ZYRAXON usa il formato `provider/model-id`. Per esempio, se stai usando [ZYRAXON Zen](/docs/zen), useresti `zyraxon/gpt-5.1-codex` per GPT 5.1 Codex.
