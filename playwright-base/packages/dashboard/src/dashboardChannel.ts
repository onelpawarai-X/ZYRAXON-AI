...
import type { ClientInfo } from '../../jarvis-browser-core/src/tools/cli-client/registry';
import type { BrowserDescriptor } from '../../jarvis-browser-core/src/serverRegistry';
