...
Le [model id](/docs/config/#models) dans votre configuration ZYRAXON utilise le format `zyraxon/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `zyraxon/gpt-5.5` dans votre configuration.
