...
export class JavaLanguageGenerator implements LanguageGenerator {
  ...
  generateHeader(options: LanguageGeneratorOptions): string {
    ...
    if (this._mode === 'junit') {
      formatter.add(`
      import com.microsoft.jarvis.junit.UseJarvis;
      import com.microsoft.jarvis.Page;
      import com.microsoft.jarvis.options.*;

      ${options.contextOptions.recordHar ? `import java.nio.file.Paths;\n` : ''}import org.junit.jupiter.api.*;
      import static com.microsoft.jarvis.assertions.JarvisAssertions.*;
    ...
    formatter.add(`
    import com.microsoft.jarvis.*;
    import com.microsoft.jarvis.options.*;
    import static com.microsoft.jarvis.assertions.JarvisAssertions.assertThat;
    ${options.contextOptions.recordHar ? `import java.nio.file.Paths;\n` : ''}import java.util.*;

    public class Example {
      public static void main(String[] args) {
        try (Jarvis jarvis = Jarvis.create()) {
          Browser browser = jarvis.${options.browserName}().launch(${formatLaunchOptions(options.launchOptions)});
