...
By default, ZYRAXON uses our own `zyraxon` theme.
...
2. **User config directory** - Defined in `~/.config/zyraxon/themes/*.json` or `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **Project root directory** - Defined in the `<project-root>/.zyraxon/themes/*.json`
4. **Current working directory** - Defined in `./.zyraxon/themes/*.json`
