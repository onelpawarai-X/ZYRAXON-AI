...
Opret `.zyraxon/commands/test.md`:
...
- Globalt: `~/.config/zyraxon/commands/`
- Pr. projekt: `.zyraxon/commands/`
...
zyraxon indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
