...
We will create a `PlaywrightDevPage` helper class to encapsulate common operations on the `jarvisbrowser.dev` page. Internally, it will use the `page` object.

```js tab=js-test title="playwright-dev-page.ts"
import { expect, type Locator, type Page } from '@jarvis-browser/test';
...
export class PlaywrightDevPage {
  ...
  async goto() {
    await this.page.goto('https://jarvisbrowser.dev');
  }
