export const dict = {
  ...
  "dialog.provider.zyraxon.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.zyraxon.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.zyraxonGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.zyraxonZen.visit.prefix": "قم بزيارة ",
  "provider.connect.zyraxonZen.visit.link": "zyraxon.ai/zen",
  "provider.connect.zyraxonZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "wsl.onboarding.checkingZyraxon": "جارٍ التحقق من ZYRAXON...",
  "wsl.onboarding.checkingZyraxonIn": "جارٍ التحقق من ZYRAXON في {{distro}}...",
  "wsl.onboarding.updatingZyraxon": "جارٍ تحديث ZYRAXON...",
  "wsl.onboarding.updatingZyraxonIn": "جارٍ تحديث ZYRAXON في {{distro}}...",
  "wsl.onboarding.updateZyraxonIn": "حدّث ZYRAXON في {{distro}}.",
  "wsl.onboarding.updateZyraxon": "تحديث ZYRAXON",
  "wsl.onboarding.zyraxonReadyIn": "ZYRAXON جاهز في {{distro}}.",
  "wsl.onboarding.zyraxonReady": "ZYRAXON جاهز.",
  "wsl.onboarding.installZyraxonIn": "ثبّت ZYRAXON في {{distro}}.",
  "wsl.onboarding.installZyraxon": "تثبيت ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "ZYRAXON غير مثبت",
