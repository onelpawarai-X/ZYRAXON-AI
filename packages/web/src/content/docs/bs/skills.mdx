...
- Konfiguracija projekta: `.zyraxon/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.zyraxon/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.zyraxon/skills/git-release/SKILL.md` ovako:
