...
El ID del modelo en su configuración ZYRAXON usa el formato `provider/model-id`. Por ejemplo, si usa [ZYRAXON Zen](/docs/zen), usaría `zyraxon/gpt-5.1-codex` para GPT 5.1 Codex.
