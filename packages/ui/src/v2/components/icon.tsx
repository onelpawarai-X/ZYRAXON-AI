...
const icons = {
  ...
  globe: {
    viewBox: "0 0 20 20",
    body: `<circle cx="10" cy="10" r="7.5" stroke="currentColor"/><path d="M2.5 10H17.5M10 2.5C11.6569 4.15685 12.5 6.96061 12.5 10C12.5 13.0394 11.6569 15.8431 10 17.5M10 2.5C8.34315 4.15685 7.5 6.96061 7.5 10C7.5 13.0394 8.34315 15.8431 10 17.5M2.5 10C4.15685 11.6569 6.96061 12.5 10 12.5C13.0394 12.5 15.8431 11.6569 17.5 10M2.5 10C4.15685 8.34315 6.96061 7.5 10 7.5C13.0394 7.5 15.8431 8.34315 17.5 10" stroke="currentColor"/>`,
  },
  mic: {
    viewBox: "0 0 20 20",
    body: `<path d="M10 2.5V12.5M10 2.5C8.34315 2.5 7 3.84315 7 5.5V7.5C7 9.15685 8.34315 10.5 10 10.5C11.6569 10.5 13 9.15685 13 7.5V5.5C13 3.84315 11.6569 2.5 10 2.5ZM6 12.5H14M7.5 12.5V14.5C7.5 16.1569 8.84315 17.5 10 17.5C11.1569 17.5 12.5 16.1569 12.5 14.5V12.5" stroke="currentColor" stroke-linecap="square"/>`,
  },
  "mic-off": {
    viewBox: "0 0 20 20",
    body: `<path d="M10 2.5V5.5M10 5.5C8.34315 5.5 7 6.84315 7 8.5V10.5M13 8.5V10.5M6 10.5H8M12 10.5H14M6 12.5H14M7.5 12.5V14.5C7.5 16.1569 8.84315 17.5 10 17.5C11.1569 17.5 12.5 16.1569 12.5 14.5V12.5" stroke="currentColor" stroke-linecap="square"/>`,
  },
  loader: {
    viewBox: "0 0 20 20",
