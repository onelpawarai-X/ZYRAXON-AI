...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `ZYRAXON_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i zyraxon otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj zyraxon konfiguraciji.
