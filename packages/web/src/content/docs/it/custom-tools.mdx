...
description: Crea strumenti che l'LLM puo chiamare in zyraxon.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di zyraxon come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.zyraxon/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/zyraxon/tools/`.
