...
class ConfigManager {
    ...
    async writeConfigAtomically(config) {
    ...
    async performConfigMutation(mutate) {
     ...
     */
    async updateValueNonBlocking(key, updater) {
        await this.init();
