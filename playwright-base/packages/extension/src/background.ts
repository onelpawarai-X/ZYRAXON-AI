...
import { ConnectedTabGroup, cleanupStaleJarvisGroups, isNonDebuggableUrl } from './connectedTabGroup';
...
class JarvisExtension {
  ...
  // Jarvis groups are stale. Connections wait on this before reconciling.
  private _cleanupPromise: Promise<void>;

  constructor() {
    chrome.runtime.onMessage.addListener(this._onMessage.bind(this));
    chrome.action.onClicked.addListener(this._onActionClicked.bind(this));
    this._cleanupPromise = cleanupStaleJarvisGroups();
  }
