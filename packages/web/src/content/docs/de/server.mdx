---
title: Server
description: Nutze den zyraxon-Server ueber HTTP.
---
...
Er stellt einen OpenAPI-Endpunkt bereit, den ein zyraxon-Client nutzen kann.
...
Setze `ZYRAXON_SERVER_PASSWORD`, um den Server mit HTTP Basic Auth zu schuetzen.
Der Benutzername ist standardmaessig `zyraxon`, kann aber mit `ZYRAXON_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `zyraxon serve` und `zyraxon web`.
...
Wenn du `zyraxon` startest, werden TUI und Server gestartet.
...
:::tip
Nutze den zyraxon-Server, um zyraxon programmatisch anzusteuern.
:::
...
Der zyraxon-Server stellt folgende APIs bereit.
