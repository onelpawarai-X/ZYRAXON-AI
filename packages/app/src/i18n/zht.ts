...
export const dict = {
  ...
  "dialog.provider.zyraxon.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.zyraxon.tagline": "可靠的優化模型",
  "dialog.provider.zyraxonGo.tagline": "適合所有人的低成本訂閱",
  ...
  "wsl.onboarding.checkingZyraxon": "正在檢查 ZYRAXON...",
  "wsl.onboarding.checkingZyraxonIn": "正在檢查 {{distro}} 中的 ZYRAXON...",
  "wsl.onboarding.updatingZyraxon": "正在更新 ZYRAXON...",
  "wsl.onboarding.updatingZyraxonIn": "正在更新 {{distro}} 中的 ZYRAXON...",
  "wsl.onboarding.updateZyraxonIn": "更新 {{distro}} 中的 ZYRAXON。",
  "wsl.onboarding.updateZyraxon": "更新 ZYRAXON",
  "wsl.onboarding.zyraxonReadyIn": "{{distro}} 中的 ZYRAXON 已就緒。",
  "wsl.onboarding.zyraxonReady": "ZYRAXON 已就緒。",
  "wsl.onboarding.installZyraxonIn": "在 {{distro}} 中安裝 ZYRAXON。",
  "wsl.onboarding.installZyraxon": "安裝 ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "未安裝 ZYRAXON",
