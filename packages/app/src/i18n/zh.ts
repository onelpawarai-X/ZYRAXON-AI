...
export const dict = {
  ...
  "dialog.provider.zyraxon.note": "使用 ZYRAXON Zen 或 API 密钥连接",
  "dialog.provider.zyraxon.tagline": "可靠的优化模型",
  "dialog.provider.zyraxonGo.tagline": "适合所有人的低成本订阅",
  ...
  "wsl.onboarding.checkingZyraxon": "正在检查 ZYRAXON...",
  "wsl.onboarding.checkingZyraxonIn": "正在检查 {{distro}} 中的 ZYRAXON...",
  ...
  "wsl.onboarding.zyraxonReadyIn": "{{distro}} 中的 ZYRAXON 已就绪。",
  "wsl.onboarding.zyraxonReady": "ZYRAXON 已就绪。",
  "wsl.onboarding.installZyraxonIn": "在 {{distro}} 中安装 ZYRAXON。",
  "wsl.onboarding.installZyraxon": "安装 ZYRAXON",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "未安装 ZYRAXON",
