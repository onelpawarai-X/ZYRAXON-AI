...
- Globalno: `~/.config/zyraxon/agents/`
- Po projektu: `.zyraxon/agents/`
...
ID modela u vašoj ZYRAXON konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [ZYRAXON Zen](/docs/zen), koristili biste `zyraxon/gpt-5.1-codex` za GPT 5.1 Codex.
