---
title: Özel Araçlar
description: LLM'un zyraxon'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. zyraxon'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.zyraxon/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/zyraxon/tools/` içine yerleştirerek.
