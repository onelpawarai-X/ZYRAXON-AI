...
- グローバル: `~/.config/zyraxon/agents/`
- プロジェクトごと: `.zyraxon/agents/`
...
ZYRAXON 設定内のモデル ID は、`provider/model-id` という形式を使用します。たとえば、[ZYRAXON Zen](/docs/zen) を使用している場合、GPT 5.1 Codex には `zyraxon/gpt-5.1-codex` を使用します。
