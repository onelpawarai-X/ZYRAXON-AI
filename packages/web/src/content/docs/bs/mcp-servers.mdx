...
Organizacije mogu obezbijediti zadane MCP servere preko svoje krajnje tačke `.well-known/zyraxon`. Ovi serveri mogu biti onemogućeni prema zadanim postavkama, omogućavajući korisnicima da se odluče za one koji su im potrebni.
...
Komanda `mcp auth` otvara pretraživač za autorizaciju. Nakon odobrenja, ZYRAXON sigurno čuva tokene u `~/.local/share/zyraxon/mcp-auth.json`.
...
Dodajte [Grep by Vercel](https://github.com/upstash/context71) MCP server za pretraživanje isječaka koda na GitHub.
