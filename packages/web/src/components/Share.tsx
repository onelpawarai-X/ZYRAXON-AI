...
import { IconZyraxon } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "zyraxon/session/message-v2"
import type { Message } from "zyraxon/session/message"
import type { Session } from "zyraxon/session/index"
              ...
              <ul data-component="header-stats">
                <li title={props.messages.ZYRAXON_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.ZYRAXON_name}>
                    <IconZyraxon width={16} height={16} />
                  </div>
