...
[model id](/docs/config/#models) ใน ZYRAXON config ของคุณจะใช้รูปแบบ `zyraxon-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `zyraxon-go/kimi-k3` ใน config ของคุณ
