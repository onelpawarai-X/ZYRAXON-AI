...
Umiejętności agenta pozwalają zyraxon odkryć instrukcje wielokrotnego użytku z repozytorium lub katalogu domowego.
...
zyraxon przeszukuje te lokalizacje:

- Project config: `.zyraxon/skills/<name>/SKILL.md`
- Global config: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
W przypadku ścieżek lokalnych projektu zyraxon przechodzi od bieżącego katalogu roboczego, aż dotrze do drzewa roboczego git.
Ładuje po drodze dowolne pasujące `skills/*/SKILL.md` w `.zyraxon/` i dowolne pasujące `.claude/skills/*/SKILL.md` lub `.agents/skills/*/SKILL.md`.

Ładowane są także definicje globalne z `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Utwórz `.zyraxon/skills/git-release/SKILL.md` w ten sposób:
...
zyraxon wymienia dostępne umiejętności w opisie narzędzia `skill`.
