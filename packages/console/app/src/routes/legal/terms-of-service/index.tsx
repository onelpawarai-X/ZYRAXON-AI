...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Zyraxon | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Zyraxon terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Zyraxon. Please read on to learn the rules and restrictions that govern your use of
                Zyraxon&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Zyraxon," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-zyraxon">What is Zyraxon?</h2>
              <p>
                Zyraxon is an AI-powered coding agent that helps you write, understand, and modify code using large
                ...
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Zyraxon enables you to
              ...
              <p>
                Zyraxon takes the privacy of its users very seriously. For the current Zyraxon Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Zyraxon?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Zyraxon;
                </li>
                <li>
              ...
              <p>
                If you use Zyraxon with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Zyraxon. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Zyraxon has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-zyraxon-ever-change-the-services">Will Zyraxon ever change the Services?</h2>
              <p>
              ...
              <p>
                Zyraxon is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Zyraxon has the sole right to decide whether you are
              ...
              <p>
                Zyraxon and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Zyraxon and all such
                parties together, the "Zyraxon Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Zyraxon Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Zyraxon Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY ZYRAXON (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                ZYRAXON PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO ZYRAXON IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Zyraxon Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Zyraxon's prior written
              ...
              <p>
                ...
                disputes and claims with Zyraxon and limits the manner in which you can seek relief from Zyraxon. Both
                you and Zyraxon acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Zyraxon's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Zyraxon will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Zyraxon will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Zyraxon may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND ZYRAXON WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Zyraxon are instead choosing to have claims and disputes resolved by
                ...
                you and Zyraxon over whether to vacate or enforce an arbitration award, YOU AND ZYRAXON WAIVE ALL
              ...
              <p>
                ...
                Zyraxon is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Zyraxon to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Zyraxon agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Zyraxon may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Zyraxon agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Zyraxon, and
                ...
                are not an employee, agent, partner, or joint venture of Zyraxon, and you do not have any authority of
                any kind to bind Zyraxon in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Zyraxon
