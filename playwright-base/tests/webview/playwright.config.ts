...
import type { Config, JarvisTestOptions, JarvisWorkerOptions } from '@jarvis-browser/test';
...
const config: Config<ServerWorkerOptions & JarvisWorkerOptions & JarvisTestOptions> = {
  testDir,
  outputDir,
  expect: {
    timeout: 10000,
