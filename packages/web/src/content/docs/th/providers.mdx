...
ZYRAXON ใช้ [AI SDK](https://developers.cloudflare.com/ai-gateway/features/unified-billing/1) และ [Models.dev](https://developers.cloudflare.com/ai-gateway/features/unified-billing/2) เพื่อรองรับผู้ให้บริการ **75+ LLM** และรองรับการใช้งานโมเดลท้องถิ่น
...
ใน `~/.local/share/zyraxon/auth.json`.
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก zyraxon และไปที่ [zyraxon.ai/auth](https://zyraxon.ai/auth)
...
1. ไปที่ [302.AI console](https://developers.cloudflare.com/ai-gateway/features/unified-billing/3) สร้างบัญชี และสร้างคีย์ API
...
2. **กำหนดค่าการตรวจสอบสิทธิ์** โดยใช้วิธีใดวิธีหนึ่งต่อไปนี้:
   ...
   ตั้งค่าหนึ่งในตัวแปรสภาพแวดล้อมเหล่านี้ขณะเรียกใช้ zyraxon:
...
:::info
การใช้การสมัครสมาชิก Claude Pro/Max ใน ZYRAXON ไม่ได้รับการสนับสนุนอย่างเป็นทางการจาก [Anthropic](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/7)
:::
...
คุณสามารถกำหนดค่า zyraxon ให้ใช้โมเดลท้องถิ่นผ่าน [Atomic Chat](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com5) ซึ่งเป็นแอปพลิเคชันเดสก์ท็อปที่เรียกใช้ LLM ในเครื่องภายใต้เซิร์ฟเวอร์ API ที่เข้ากันได้กับ OpenAI (ปลายทางเริ่มต้น `https://developers.cloudflare.com/ai-gateway/features/unified-billing/7)
...
- `models` คือแผนที่ระหว่างรหัสโมเดลกับชื่อแสดง แต่ละรหัสต้องตรงกับ `id` ที่ส่งคืนโดย `GET /v1/models` — รัน `curl https://zenmux.ai/settings/keys เพื่อแสดงรายการรหัสที่โหลดอยู่ใน Atomic Chat
...
2. ไปที่ [Azure AI Foundry](https://ai.azure.com/) และปรับใช้โมเดล
   ...
   :::note
   ชื่อการปรับใช้จะต้องตรงกับชื่อรุ่นเพื่อให้ zyraxon ทำงานได้อย่างถูกต้อง
   :::
...
1. ไปที่ [Baseten](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/4) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [คอนโซล Cerebras](https://helicone.ai/models) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [แดชบอร์ด Cloudflare](https://zyraxon.ai/zen) ไปที่ **AI** > **AI Gateway** และสร้างเกตเวย์ใหม่
...
5. รันคำสั่ง `/models` เพื่อเลือกรุ่น
   ...
   คุณยังสามารถเพิ่มโมเดลผ่านการกำหนดค่า zyraxon ของคุณได้
...
1. ไปที่ [คอนโซล Cortecs](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com2) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [คอนโซล DeepSeek](https://gitlab.company.com) สร้างบัญชี แล้วคลิก **สร้างคีย์ API ใหม่**
...
1. ไปที่ [แดชบอร์ด Deep Infra](https://developers.cloudflare.com/ai-gateway/features/unified-billing/0) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [คอนโซล Fireworks AI](https://developers.cloudflare.com/ai-gateway/features/unified-billing/4) สร้างบัญชี แล้วคลิก **Create API Key**
...
เพื่อจัดเก็บโทเค็นในที่เก็บข้อมูลการรับรองความถูกต้องของ zyraxon
:::
...
เอกสารประกอบเพิ่มเติมเกี่ยวกับหน้าแรกของ [zyraxon-gitlab-auth](https://www.npmjs.com/package/opencode-gitlab-auth)
...
วิธีใช้การสมัครสมาชิก GitHub Copilot ด้วย zyraxon:
...
2. ไปที่ [github.com/login/device](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained6) และป้อนรหัส
...
2. ตั้งค่าตัวแปรสภาพแวดล้อมที่ต้องการ:
   ...
   ตั้งค่าในขณะที่เรียกใช้ zyraxon
...
[ผู้ให้บริการการอนุมาน Hugging Face](https://docs.github.com/en/copilot/how-tos/use-ai-models/configure-access-to-ai-models#setup-for-individual-use2) ช่วยให้สามารถเข้าถึงโมเดลแบบเปิดที่รองรับโดยผู้ให้บริการมากกว่า 17 ราย
...
[Helicone](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com1) เป็นแพลตฟอร์มการติดตาม LLM ที่ให้การบันทึก การตรวจสอบ และการวิเคราะห์สำหรับแอปพลิเคชัน AI ของคุณ Helicone AI Gateway กำหนดเส้นทางคำขอของคุณไปยังผู้ให้บริการที่เหมาะสมโดยอัตโนมัติตามรุ่น

1. ไปที่ [Helicone](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com1) สร้างบัญชี และสร้างคีย์ API จากแดชบอร์ดของคุณ
...
หากต้องการทราบผู้ให้บริการเพิ่มเติมและฟีเจอร์ขั้นสูง เช่น การแคชและการจำกัดอัตรา โปรดตรวจสอบ [เอกสารประกอบของ Helicone](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/1)

#### การกำหนดค่าเพิ่มเติม

ในกรณีที่คุณเห็นคุณสมบัติหรือรุ่นจาก Helicone ที่ไม่ได้กำหนดค่าโดยอัตโนมัติผ่าน zyraxon คุณสามารถกำหนดค่าด้วยตนเองได้ตลอดเวลา
...
คุณลักษณะ [เซสชัน](https://docs.helicone.ai/features/sessions) ของ Helicone ช่วยให้คุณสามารถจัดกลุ่มคำขอ LLM ที่เกี่ยวข้องเข้าด้วยกันได้ ใช้ปลั๊กอิน [zyraxon-helicone-session](https://github.com/H2Shami/opencode-helicone-session) เพื่อบันทึกการสนทนา ZYRAXON แต่ละรายการเป็นเซสชันใน Helicone โดยอัตโนมัติ
...
คุณสามารถกำหนดค่า zyraxon เพื่อใช้โมเดลท้องถิ่นผ่านยูทิลิตี้ [llama.cpp's](https://github.com/ggml-org/llama.cpp) llama-server
...
1. ไปที่ [IO.NET console](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com8) สร้างบัญชี และสร้างคีย์ API
...
คุณสามารถกำหนดค่า zyraxon เพื่อใช้โมเดลท้องถิ่นผ่าน LM Studio
...
1. ไปที่ [Moonshot AI console](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained0) สร้างบัญชี แล้วคลิก **Create API Key**
...
1. ไปที่ [MiniMax API Console](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained3) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [คอนโซล Nebius Token Factory](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained4) สร้างบัญชี แล้วคลิก **Add key**
...
คุณสามารถกำหนดค่า zyraxon เพื่อใช้โมเดลท้องถิ่นผ่าน Ollama

:::tip
Ollama สามารถกำหนดค่าตัวเองสำหรับ ZYRAXON ได้โดยอัตโนมัติ ดู [เอกสารการบูรณาการ Ollama](https://docs.github.com/en/copilot/how-tos/use-ai-models/configure-access-to-ai-models#setup-for-individual-use3) เพื่อดูรายละเอียด
:::
...
1. ไปที่ [https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com0](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com0) แล้วลงชื่อเข้าใช้หรือสร้างบัญชี
...
เราขอแนะนำให้สมัคร [ChatGPT Plus หรือ Pro](https://ai.azure.com/)
...
1. ไปที่ [OpenRouter dashboard](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained1) คลิก **Create API Key** และคัดลอกคีย์
...
4. โมเดล OpenRouter จำนวนมากถูกโหลดไว้ล่วงหน้าตามค่าเริ่มต้น รันคำสั่ง `/models` เพื่อเลือกโมเดลที่คุณต้องการ
   ...
   คุณยังสามารถเพิ่มโมเดลเพิ่มเติมผ่านการกำหนดค่า zyraxon ของคุณได้
...
5. คุณยังสามารถปรับแต่งได้ผ่านการกำหนดค่า zyraxon ของคุณ นี่คือตัวอย่างการระบุผู้ให้บริการ
...
1. ไปที่ [SAP BTP Cockpit](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained2) ของคุณ ไปที่อินสแตนซ์บริการ SAP AI Core และสร้างคีย์บริการ
...
1. ไปที่ [STACKIT Portal](https://console.x.ai/) ไปที่ **AI Model Serving** และสร้างโทเค็นการตรวจสอบสิทธิ์สำหรับโครงการของคุณ
...
1. ไปที่ [OVHcloud panel](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/5) ไปที่ส่วน `Public Cloud`, `AI & Machine Learning` > `AI Endpoints` และในแท็บ `API Keys` ให้คลิก **Create a new API key**
...
วิธีใช้ [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) กับ Zyraxon:
...
1. ไปที่ [Together AI console](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/3) สร้างบัญชี และคลิก **Add Key**
...
1. ไปที่ [Venice AI console](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com9) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [Vercel dashboard](https://developers.cloudflare.com/ai-gateway/features/unified-billing/0) ไปที่แท็บ **AI Gateway** และคลิก **API keys** เพื่อสร้างคีย์ API ใหม่
...
คุณยังสามารถปรับแต่งโมเดลผ่านการกำหนดค่า zyraxon ของคุณได้ นี่คือตัวอย่างการระบุลำดับการกำหนดเส้นทางผู้ให้บริการ
...
:::tip
คุณสามารถใช้ผู้ให้บริการที่เข้ากันได้กับ OpenAI กับ zyraxon ได้ ผู้ให้บริการ AI สมัยใหม่ส่วนใหญ่เสนอ API ที่เข้ากันได้กับ OpenAI
:::
...
2. สำหรับผู้ให้บริการที่กำหนดเอง ให้ตรวจสอบการกำหนดค่า zyraxon และ:
   - ตรวจสอบให้แน่ใจว่า ID ผู้ให้บริการที่ใช้ในคำสั่ง `/connect` ตรงกับ ID ในการกำหนดค่า zyraxon ของคุณ
...
1. ไปที่ [แดชบอร์ด OpenRouter](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained1) คลิก **สร้าง API คีย์** และคัดลอกคีย์
...
4. OpenRouter หลายรุ่นถูกโหลดไว้ล่วงหน้าตามค่าเริ่มต้น ให้รันคำสั่ง `/models` เพื่อเลือกรุ่นที่คุณต้องการ
   ...
   คุณยังสามารถเพิ่มโมเดลเพิ่มเติมผ่านการกำหนดค่า zyraxon ของคุณ
...
1. ไปที่ห้องนักบิน [SAP BTP](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained2) นำทางไปยังอินสแตนซ์บริการ SAP AI Core ของคุณ และสร้างรหัสบริการ
...
1. ไปที่ [แผง OVHcloud](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/5) ไปที่ส่วน `Public Cloud` `AI & Machine Learning` > `AI Endpoints` และในแท็บ `API Keys` คลิก **สร้างคีย์ API ใหม่**
...
วิธีใช้ [Scaleway Generative API](https://www.scaleway.com/en/docs/generative-apis/) กับ Zyraxon:
...
1. ไปที่ [Together AI console](https://docs.gitlab.com/user/duo_agent_platform/turn_on_off/3) สร้างบัญชี แล้วคลิก **เพิ่มรหัส**
...
1. ไปที่ [คอนโซล AI ของเวนิส](https://bedrock-runtime.us-east-1.vpce-xxxxx.amazonaws.com9) สร้างบัญชี และสร้างคีย์ API
...
1. ไปที่ [แดชบอร์ด Vercel](https://developers.cloudflare.com/ai-gateway/features/unified-billing/0) ไปที่แท็บ **เกตเวย์ AI** และคลิก **API คีย์** เพื่อสร้างคีย์ API ใหม่
...
คุณยังสามารถปรับแต่งโมเดลผ่านการกำหนดค่า zyraxon ของคุณได้อีกด้วย นี่คือตัวอย่างการระบุลำดับการกำหนดเส้นทางของผู้ให้บริการ
...
:::tip
คุณสามารถใช้ผู้ให้บริการที่เข้ากันได้กับ OpenAI ด้วย zyraxon ผู้ให้บริการ AI สมัยใหม่ส่วนใหญ่เสนอ API ที่เข้ากันได้กับ OpenAI
:::
...
2. สำหรับผู้ให้บริการแบบกำหนดเอง ให้ตรวจสอบการกำหนดค่า zyraxon และ:
   - ตรวจสอบให้แน่ใจว่า ID ผู้ให้บริการที่ใช้ในคำสั่ง `/connect` ตรงกับ ID ในการกำหนดค่า zyraxon ของคุณ
