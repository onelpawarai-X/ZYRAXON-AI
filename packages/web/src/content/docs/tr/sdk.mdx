---
title: SDK
description: zyraxon sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

zyraxon JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
zyraxon'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Halihazırda çalışan bir zyraxon örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
