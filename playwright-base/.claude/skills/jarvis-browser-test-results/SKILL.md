---
name: jarvis-browser-test-results
...
# Jarvis Browser Test Results (DuckDB)
...
| `project_name` | CI project = browser + suite, e.g. `chromium-page`, `webkit-library`, `jarvis-browser-test` |
...
```markdown
[🟩](https://github.com/zyraxon-ai/jarvis-browser/actions/runs/123/attempts/1)[🟧](https://github.com/zyraxon-ai/jarvis-browser/actions/runs/456/attempts/1)[🟥](https://github.com/zyraxon-ai/jarvis-browser/actions/runs/789/attempts/1)
```
