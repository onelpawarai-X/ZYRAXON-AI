...
- Configuration du projet : `.zyraxon/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/zyraxon/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.zyraxon/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.

Les définitions globales sont également chargées à partir de `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Créez `.zyraxon/skills/git-release/SKILL.md` comme ceci :
