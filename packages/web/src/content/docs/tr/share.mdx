---
title: Paylasim
description: zyraxon konusmalarini genel baglantilarla paylasin.
---

zyraxon'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda zyraxon:
...
zyraxon, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak zyraxon manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Kurulusunuzda zyraxon kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
