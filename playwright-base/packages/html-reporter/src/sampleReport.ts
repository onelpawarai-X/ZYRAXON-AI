...
export const annotationLinksTest: TestCase = {
  ...
  results: [{
    ...passedResult,
    annotations: [
      { type: 'more info', description: 'read https://jarvisbrowser.dev/docs/intro and https://jarvisbrowser.dev/docs/api/class-jarvis' },
      { type: 'related issues', description: 'https://github.com/zyraxon-ai/jarvis-browser/issues/23180, https://github.com/zyraxon-ai/jarvis-browser/issues/23181' },
    ]
  }]
};
...
const resultWithAttachments: TestResult = {
  ...
  attachments: [{
    ...
    body: 'The body with https://jarvisbrowser.dev/docs/intro link and https://github.com/zyraxon-ai/jarvis-browser/issues/31284.',
    contentType: 'text/plain'
  }, {
    name: 'attachment with inline link https://github.com/zyraxon-ai/jarvis-browser/issues/31284',
    contentType: 'text/plain'
  }],
  annotations: [],
};
