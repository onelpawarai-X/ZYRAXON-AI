...
Playwright Trace Viewer is a GUI tool that helps you explore recorded Playwright traces after the script has run. Traces are a great way for debugging your tests when they fail on CI. You can open traces [locally](#opening-trace-viewer) or in your browser on [trace.jarvisbrowser.dev](https://trace.jarvisbrowser.dev).
...
You can open a saved trace using either the Playwright CLI or in the browser at [trace.jarvisbrowser.dev](https://trace.jarvisbrowser.dev). Make sure to add the full path to where your `trace.zip` file is located.
...
### Using [trace.jarvisbrowser.dev](https://trace.jarvisbrowser.dev)

[trace.jarvisbrowser.dev](https://trace.jarvisbrowser.dev) is a statically hosted variant of the Trace Viewer. You can upload a trace file using drag and drop or via the `Select file` button.
...
When using [trace.jarvisbrowser.dev](https://trace.jarvisbrowser.dev), you can also pass the URL of your uploaded trace at some accessible storage (e.g. inside your CI) as a query parameter. CORS (Cross-Origin Resource Sharing) rules might apply.

```txt
https://trace.jarvisbrowser.dev/?trace=https://demo.jarvisbrowser.dev/reports/todomvc/data/e6099cadf79aa753d5500aa9508f9d1dbd87b5ee.zip
```
...
page.goto("https://jarvisbrowser.dev")
...
page.navigate("https://jarvisbrowser.dev");
...
public class UnitTest1 : PageTest
{
    ...
    {
        // ...
        await Page.GotoAsync("https://jarvisbrowser.dev/dotnet/docs/intro");
    }
}
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/948b65cd-f0fd-4c7f-8e53-2c632b5a07f1" alt="actions tab in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/b04a7d75-54bb-4ab2-9e30-e76f6f74a2c8" alt="timeline view in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/7168d549-eb0a-4964-9c93-483f03711fa9" alt="action tab in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/daa8845d-c250-4923-aa7a-5d040da9adc5" alt="showing source code tab in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/95498580-f9dd-4932-a123-c37fe7cfc3c2" alt="showing call tab in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/de621461-3bab-4140-b39d-9f02d6672dbf" alt="showing log of tests in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/e9ef77b3-05d1-4df2-852c-981023723d34" alt="showing errors in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/4107c08d-1eaf-421c-bdd4-9dd2aa641d4a" alt="showing log of tests in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/0a3d1671-8ccd-4f7a-a844-35f5eb37f236" alt="network requests tab in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/82ab3d33-1ec9-4b8a-9cf2-30a6e2d59091" alt="meta data in trace viewer" width="3598" height="2218" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/4386178a-5808-4fa8-9436-315350a23b04" alt="attachments tab in trace viewer" width="3598" height="2218" />
