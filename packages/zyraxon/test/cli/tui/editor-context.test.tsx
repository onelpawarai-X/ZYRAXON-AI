...
import { EditorContextProvider, useEditorContext, type EditorIntegration } from "@zyraxon-ai/tui/context/editor"
import { tmpdir } from "../../fixture/fixture"
import { FakeWebSocket } from "../../lib/websocket"
import { TestTuiContexts } from "../../fixture/tui-environment"
import { discoverEditorConnection } from "@zyraxon-ai/tui/editor"

const originalClaudePort = process.env.CLAUDE_CODE_SSE_PORT
const originalZyraxonPort = process.env.ZYRAXON_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.ZYRAXON_EDITOR_SSE_PORT = originalZyraxonPort
})
