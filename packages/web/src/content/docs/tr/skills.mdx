...
Ajan becerileri, zyraxon'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
zyraxon su konumlari tarar:

- Proje konfigurasyonu: `.zyraxon/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
Proje yerel yollarinda zyraxon, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.zyraxon/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.zyraxon/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
zyraxon, `skill` araci aciklamasinda mevcut becerileri listeler.
