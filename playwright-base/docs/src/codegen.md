...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/1d4c8f37-8325-4816-a665-d0e95e63f509" alt="generating user actions" width="2788" height="1824" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/d131eb35-b2ca-4bf4-a8ac-88b6e40dcf07" alt="generating assertions" width="2788" height="1400" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/2ba4c212-4713-460a-b054-6dc6b67a9a7c" alt="code from a generated test" width="3126" height="1654" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/77948ab8-92a2-435f-9833-0944da5ae664" alt="record at cursor in vs code" width="3126" height="1756" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/4f4bb34e-9cda-41fe-bf65-8d8016d84c7f" alt="code from a generated test" width="3180" height="1944" />
...
```bash js
npx playwright codegen demo.jarvisbrowser.dev/todomvc
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen demo.jarvisbrowser.dev/todomvc"
```

```bash python
playwright codegen demo.jarvisbrowser.dev/todomvc
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen demo.jarvisbrowser.dev/todomvc
```
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/34a79ea1-639e-4cb3-8115-bfdc78e3d34d" alt="Recording a test" width="2788" height="1824" />

######
* langs: java

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/ec9c4071-4af8-4ae7-8b36-aebcc29bdbbb" alt="recording a test" width="2788" height="1824" />

######
* langs: python

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/9751b609-6e4c-486b-a961-f86f177b1d58" alt="recording a test" width="2788" height="1824" />

######
* langs: csharp

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/53bdfb6f-d462-4ce0-ab95-0619faaebf1e" alt="recording a test" width="2788" height="1824" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/2c8a12e2-4e98-4fdd-af92-1d73ae696d86" alt="picking a locator" width="2788" height="1824" />

######
* langs: java

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/733b48fd-5edf-4150-93f0-018adc52b6ff" alt="picking a locator" width="2700" height="1736" />

######
* langs: python

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/95d11f48-96a4-46b9-9c2a-63c3aa4fdce7" alt="picking a locator" width="2788" height="1824" />

######
* langs: csharp

<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/1478f56f-422f-4276-9696-0674041f11dc" alt="picking a locator" width="2788" height="1824" />
...
```bash js
npx playwright codegen --viewport-size="800,600" jarvisbrowser.dev
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen --viewport-size='800,600' jarvisbrowser.dev"
```

```bash python
playwright codegen --viewport-size="800,600" jarvisbrowser.dev
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen --viewport-size="800,600" jarvisbrowser.dev
```
######
* langs: js

<img height="1496" width="1740" alt="Codegen generating code for tests for jarvisbrowser.dev website with a specific viewport js" src="https://user-images.githubusercontent.com/13063165/220402029-f90d1c9f-d740-4c0f-acc8-95235ee83f85.png" />

######
* langs: java

<img height="1496" width="1740" alt="Codegen generating code for tests for jarvisbrowser.dev website with a specific viewport java" src="https://user-images.githubusercontent.com/13063165/220402748-12a856c2-b3ff-4155-b82d-64dad9c46886.png" />

######
* langs: python

<img height="1496" width="1740" alt="Codegen generating code for tests for jarvisbrowser.dev website with a specific viewport python" src="https://user-images.githubusercontent.com/13063165/220403118-7704b708-dea3-44b3-97a4-04c2b9d1d0fa.png" />

######
* langs: csharp

<img height="1496" width="1740" alt="Codegen generating code for tests for jarvisbrowser.dev website with a specific viewport dotnet" src="https://user-images.githubusercontent.com/13063165/220403496-4a46a9a1-4bc4-43e7-8f22-9cc760ceadaf.png" />
...
```bash js
npx playwright codegen --device="iPhone 13" jarvisbrowser.dev
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args='codegen --device="iPhone 13" jarvisbrowser.dev'
```

```bash python
playwright codegen --device="iPhone 13" jarvisbrowser.dev
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen --device="iPhone 13" jarvisbrowser.dev
```
######
* langs: js

<img height="1660" width="2600" alt="Codegen generating code for tests for jarvisbrowser.dev website emulated for iPhone 13 js" src="https://user-images.githubusercontent.com/13063165/220921482-dc4f5532-9dce-40bd-8a28-e0d87d26a601.png" />

######
* langs: java

<img height="1660" width="2600" alt="Codegen generating code for tests for jarvisbrowser.dev website emulated for iPhone 13 java" src="https://user-images.githubusercontent.com/13063165/220922591-241e6a59-a920-4cb1-97a2-d46c33ea17c5.png" />

######
* langs: python

<img height="1660" width="2600" alt="Codegen generating code for tests for jarvisbrowser.dev website emulated for iPhone 13 python" src="https://user-images.githubusercontent.com/13063165/220922790-5c5a4d1a-e27d-4c9b-90ac-13cf9c925706.png" />

######
* langs: csharp

<img height="1660" width="2600" alt="Codegen generating code for tests for jarvisbrowser.dev website emulated for iPhone 13 csharp" src="https://user-images.githubusercontent.com/13063165/220923048-f13583b1-ab08-4702-ab74-58691d50acfe.png" />
...
```bash js
npx playwright codegen --color-scheme=dark jarvisbrowser.dev
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen --color-scheme=dark jarvisbrowser.dev"
```

```bash python
playwright codegen --color-scheme=dark jarvisbrowser.dev
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen --color-scheme=dark jarvisbrowser.dev
```

######
* langs: js

<img height="1824" width="2788" alt="Codegen generating code for tests for jarvisbrowser.dev website in dark mode js" src="https://user-images.githubusercontent.com/13063165/220930273-f3a25bae-64dd-4bbb-99ed-1e97c0cb1ebf.png" />

######
* langs: java

<img height="1824" width="2788" alt="Codegen generating code for tests for jarvisbrowser.dev website in dark mode java" src="https://user-images.githubusercontent.com/13063165/220930514-3b105fab-c87e-4f58-affa-d11d570122a8.png" />

######
* langs: python

<img height="1824" width="2788" alt="Codegen generating code for tests for jarvisbrowser.dev website in dark mode python" src="https://user-images.githubusercontent.com/13063165/220930714-737647fd-ae99-4dd3-b7a4-4f3eb4fe712d.png" />

######
* langs: csharp

<img height="1824" width="2788" alt="Codegen generating code for tests for jarvisbrowser.dev website in dark mode csharp" src="https://user-images.githubusercontent.com/13063165/220930893-c1d0df65-c662-4b33-91eb-ea10552d7cc5.png" />
...
```bash js
npx playwright codegen github.com/zyraxon-ai/jarvis-browser --save-storage=auth.json
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen github.com/zyraxon-ai/jarvis-browser  --save-storage=auth.json"
```

```bash python
playwright codegen github.com/zyraxon-ai/jarvis-browser --save-storage=auth.json
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen github.com/zyraxon-ai/jarvis-browser --save-storage=auth.json
```
...
```bash js
npx playwright codegen --load-storage=auth.json github.com/zyraxon-ai/jarvis-browser
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen --load-storage=auth.json github.com/zyraxon-ai/jarvis-browser"
```

```bash python
playwright codegen --load-storage=auth.json github.com/zyraxon-ai/jarvis-browser
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen --load-storage=auth.json github.com/zyraxon-ai/jarvis-browser
```
...
Run `codegen` with `--user-data-dir` to set a fixed [user data directory](https://jarvisbrowser.dev/docs/api/class-browsertype#browser-type-launch-persistent-context-option-user-data-dir) for the browser session. If you create a custom browser user data directory, codegen will use this existing browser profile and have access to any authentication state present in that profile.
...
```bash js
npx playwright codegen --user-data-dir=/path/to/your/browser/data/ github.com/zyraxon-ai/jarvis-browser
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="codegen --user-data-dir=/path/to/your/browser/data/ github.com/zyraxon-ai/jarvis-browser"
```

```bash python
playwright codegen --user-data-dir=/path/to/your/browser/data/ github.com/zyraxon-ai/jarvis-browser
```

```bash csharp
pwsh bin/Debug/netX/playwright.ps1 codegen --user-data-dir=/path/to/your/browser/data/ github.com/zyraxon-ai/jarvis-browser
```
...
```js
const { chromium } = require('@jarvis-browser/test');
