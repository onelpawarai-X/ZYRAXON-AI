...
- `.zyraxon/plugins/` – Plugins auf Projektebene
...
**NPM-Plugins** werden beim Start automatisch mit Bun installiert. Pakete und ihre Abhängigkeiten werden in `~/.cache/zyraxon/node_modules/` zwischengespeichert.
...
1. Globale Konfiguration (`~/.config/zyraxon/zyraxon.json`)
2. Projektkonfiguration (`zyraxon.json`)
3. Globales Plugin-Verzeichnis (`~/.config/zyraxon/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.zyraxon/plugins/`)
