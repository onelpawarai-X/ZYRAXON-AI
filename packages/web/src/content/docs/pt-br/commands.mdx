...
Você pode adicionar comandos personalizados através da configuração do zyraxon ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do zyraxon:
...
- Global: `~/.config/zyraxon/commands/`
- Por projeto: `.zyraxon/commands/`
...
zyraxon inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
