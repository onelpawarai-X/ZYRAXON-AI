...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `ZYRAXON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og zyraxon åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din zyraxon-konfiguration.
