...
export const dict = {
  ...
  "dialog.provider.zyraxon.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.zyraxon.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.zyraxonGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "wsl.onboarding.checkingZyraxon": "ZYRAXON kontrol ediliyor...",
  "wsl.onboarding.checkingZyraxonIn": "{{distro}} içinde ZYRAXON kontrol ediliyor...",
  "wsl.onboarding.updatingZyraxon": "ZYRAXON güncelleniyor...",
  "wsl.onboarding.updatingZyraxonIn": "{{distro}} içinde ZYRAXON güncelleniyor...",
  "wsl.onboarding.updateZyraxonIn": "{{distro}} içindeki ZYRAXON'u güncelleyin.",
  "wsl.onboarding.updateZyraxon": "ZYRAXON'u güncelle",
  "wsl.onboarding.zyraxonReadyIn": "{{distro}} içinde ZYRAXON hazır.",
  "wsl.onboarding.zyraxonReady": "ZYRAXON hazır.",
  "wsl.onboarding.installZyraxonIn": "ZYRAXON'u {{distro}} içine kurun.",
  "wsl.onboarding.installZyraxon": "ZYRAXON'u kur",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "ZYRAXON kurulu değil",
