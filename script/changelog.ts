...
Generates UPCOMING_CHANGELOG.md by running the zyraxon changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for zyraxon run (default: low)
      --quiet            Suppress zyraxon command output unless it fails
