...
```txt
Use playwright skills to test https://demo.jarvisbrowser.dev/todomvc/.
...
```txt
### Page
- Page URL: https://demo.jarvisbrowser.dev/todomvc/#/
...
```bash
playwright-cli open https://jarvisbrowser.dev
...
```bash
playwright-cli open https://jarvisbrowser.dev --headed
```
...
This requires the [Playwright Extension](https://github.com/zyraxon-ai/jarvis-browser/blob/main/packages/extension/README.md) to be installed.
