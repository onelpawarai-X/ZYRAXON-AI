...
export class BrowserContext extends ChannelOwner<channels.BrowserContextChannel> implements api.BrowserContext {
  ...
  _onClose() {
    ...
    this._browser?._browserType._jarvis.selectors._contextsForSelectors.delete(this);
    this._disposeHarRouters();
...
export async function toClientCertificatesProtocol(certs?: BrowserContextOptions['clientCertificates']): Promise<channels.JarvisNewRequestParams['clientCertificates']> {
  if (!certs)
    return undefined;
