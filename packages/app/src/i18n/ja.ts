export const dict = {
  ...
  "dialog.provider.zyraxon.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.zyraxon.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.zyraxonGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "wsl.onboarding.checkingZyraxon": "ZYRAXONを確認中...",
  "wsl.onboarding.checkingZyraxonIn": "{{distro}}内のZYRAXONを確認中...",
  "wsl.onboarding.updatingZyraxon": "ZYRAXONを更新中...",
  "wsl.onboarding.updatingZyraxonIn": "{{distro}}内のZYRAXONを更新中...",
  "wsl.onboarding.updateZyraxonIn": "{{distro}}内のZYRAXONを更新してください。",
  "wsl.onboarding.updateZyraxon": "ZYRAXONを更新",
  "wsl.onboarding.zyraxonReadyIn": "{{distro}}内のZYRAXONの準備ができました。",
  "wsl.onboarding.zyraxonReady": "ZYRAXONの準備ができました。",
  "wsl.onboarding.installZyraxonIn": "{{distro}}にZYRAXONをインストールしてください。",
  "wsl.onboarding.installZyraxon": "ZYRAXONをインストール",
  ...
  "wsl.onboarding.distroStatus.zyraxonMissing": "ZYRAXONがインストールされていません",
