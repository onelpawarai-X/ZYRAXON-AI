...
export async function skipWelcomePageOnboarding() {
...
function isWelcomePageClientExcluded(clientName) {
    ...
    return configuredClients.some((configuredClient) => typeof configuredClient === 'string'
