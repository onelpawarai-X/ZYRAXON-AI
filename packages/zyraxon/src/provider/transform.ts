...
export function variants(model: Provider.Model): Record<string, Record<string, any>> {
  ...
  switch (model.api.npm) {
    ...
    // https://docs.x.ai/docs/guides/reasoning#control-how-hard-the-model-thinks1
    ...
    case "@ai-sdk/azure":
      // https://docs.x.ai/docs/guides/reasoning#control-how-hard-the-model-thinks5
    ...
    case "@ai-sdk/mistral":
      // https://docs.x.ai/docs/guides/reasoning#control-how-hard-the-model-thinks2
      // https://docs.x.ai/docs/guides/reasoning#control-how-hard-the-model-thinks0
      if (!model.capabilities.reasoning) return {}
    ...
    case "@ai-sdk/groq":
      // https://docs.x.ai/docs/guides/reasoning#control-how-hard-the-model-thinks6
...
export function options(input: {
  ...
  if (
    ...
    (input.model.providerID === "zyraxon" && ["kimi-k2-thinking", "glm-4.6"].includes(input.model.api.id))
  ) {
...
export function schema(model: Provider.Model, schema: JSONSchema7): JSONSchema7 {
  ...
  */
  ...
  if (model.api.npm === "@ai-sdk/openai" || model.api.npm === "@ai-sdk/azure") {
    ...
    // Codex also applies lossy compaction above 4 KB; defer that until Zyraxon needs the same schema budget.
  }
