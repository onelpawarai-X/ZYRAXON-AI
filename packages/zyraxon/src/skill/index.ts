...
import { SkillPlugin } from "@zyraxon-ai/core/plugin/skill"
...
// Built-in skill that ships with zyraxon. The model's intuition for what an
// zyraxon.json should look like is often wrong, and zyraxon hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch zyraxon's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_ZYRAXON_SKILL_NAME = "customize-zyraxon"
const CUSTOMIZE_ZYRAXON_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating zyraxon's own configuration: zyraxon.json, zyraxon.jsonc, files under .zyraxon/, or files under ~/.config/zyraxon/. Also use when creating or fixing zyraxon agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring zyraxon itself."
const CUSTOMIZE_ZYRAXON_SKILL_BODY = SkillPlugin.CustomizeZyraxonContent
