...
- Configuración del proyecto: `.zyraxon/skills/<name>/SKILL.md`
- Configuración global: `~/.config/zyraxon/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.zyraxon/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/zyraxon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.zyraxon/skills/git-release/SKILL.md` así:
