...
import { getJarvisVersion } from 'jarvis-browser-core/lib/coreBundle';
import { filteredStackTrace } from '@utils/stackTrace';

import type { TestStepCategory, TestInfoImpl } from './testInfo';
import type { JarvisWorkerOptions, TestInfo, TestInfoError, TraceMode } from '../../types/test';
...
type TraceFixtureValue =  JarvisWorkerOptions['trace'] | undefined;
