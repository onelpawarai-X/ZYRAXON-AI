...
- عام: `~/.config/zyraxon/agents/`
- لكل مشروع: `.zyraxon/agents/`
...
يستخدم معرّف النموذج في إعدادات ZYRAXON الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [ZYRAXON Zen](/docs/zen)، فستستخدم `zyraxon/gpt-5.1-codex` لـ GPT 5.1 Codex.
