---
title: TUI
description: Usando a interface de usuário de terminal zyraxon.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O zyraxon fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar zyraxon inicia o TUI para o diretório atual.
...
Ao usar o TUI do zyraxon, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao zyraxon. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do zyraxon. _Aliases_: `/quit`, `/q`
...
Use `ZYRAXON_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `zyraxon.default`.
