...
test("mocks a fruit and doesn't call api", async ({ page }) => {
  ...
  // Go to the page
  await page.goto('https://demo.jarvisbrowser.dev/api-mocking');
...
def test_mock_the_fruit_api(page: Page):
    ...
    # Go to the page
    page.goto("https://demo.jarvisbrowser.dev/api-mocking")
...
// Go to the page
await page.GotoAsync("https://demo.jarvisbrowser.dev/api-mocking");
...
// Go to the page
page.navigate("https://demo.jarvisbrowser.dev/api-mocking");
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/3dc14cbf-c100-4efc-ac21-d7b52d698b53" alt="api mocking trace" width="2946" height="1902" />
...
async def test_gets_the_json_from_api_and_adds_a_new_fruit(page: Page):
    ...
    await page.route("https://demo.jarvisbrowser.dev/api-mocking/api/v1/fruits", handle)
...
def test_gets_the_json_from_api_and_adds_a_new_fruit(page: Page):
    ...
    page.route("https://demo.jarvisbrowser.dev/api-mocking/api/v1/fruits", handle)
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/8b8dd82d-1b3e-428e-871b-840581fed439" alt="trace of test showing api being called and fulfilled" width="2946" height="1902" />

By inspecting the response we can see that our new fruit was added to the list.
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/03e6c87c-4ecc-47e8-9ca0-30fface25e9d" alt="trace of test showing the mock response" width="2946" height="1902" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/1bd7ab66-ea4f-43c2-a4e5-ca17d4837ff1" alt="trace showing the HAR file being used" width="2946" height="1902" />
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/13063165/db3117fc-7b02-4973-9a51-29e213261a6a" alt="trace showing response from HAR file" width="2946" height="1902" />
