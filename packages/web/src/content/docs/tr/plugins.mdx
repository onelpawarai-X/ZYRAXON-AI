...
- `.zyraxon/plugins/` - Proje düzeyinde eklentiler
- `~/.config/zyraxon/plugins/` - Genel eklentiler
...
**npm eklentileri** başlangıçta Bun kullanılarak otomatik olarak yüklenir. Paketler ve bağımlılıkları `~/.cache/zyraxon/node_modules/`'da önbelleğe alınır.
...
3. Global eklenti dizini (`~/.config/zyraxon/plugins/`)
4. Proje eklenti dizini (`.zyraxon/plugins/`)
