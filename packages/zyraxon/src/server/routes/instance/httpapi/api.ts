...
import { makeApi } from "@zyraxon-ai/protocol/api"
import { LocationMiddleware } from "@zyraxon-ai/server/location"
import { SessionLocationMiddleware } from "@zyraxon-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("zyraxon-root")
...
export const InstanceHttpApi = HttpApi.make("zyraxon-instance")
