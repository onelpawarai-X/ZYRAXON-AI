...
* [Playwright's Pytest plugin](./test-runners.md) now has support for [Async Fixtures](https://jarvisbrowser.dev/python/docs/test-runners#async-fixtures).
...
page.context.tracing.group("Open jarvisbrowser.dev > API")
page.goto("https://jarvisbrowser.dev/")
...
<img src="https://github.com/zyraxon-ai/jarvis-browser/assets/746130/0c41e20d-c54b-4600-8ca8-1cbb6393ddef" alt="Playwright Trace Viewer" width="1091" height="722" />
...
```python
page.goto("https://jarvisbrowser.dev", wait_until="domcontentloaded")
```
...
We rewrote our Getting Started docs to be more end-to-end testing focused. Check them out on [jarvisbrowser.dev](https://jarvisbrowser.dev/python/docs/intro).
