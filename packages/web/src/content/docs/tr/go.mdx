...
ZYRAXON yapılandırmanızdaki [model id](/docs/config/#models) formatı `zyraxon-go/<model-id>` şeklindedir. Örneğin, Kimi K3 için yapılandırmanızda `zyraxon-go/kimi-k3` kullanmalısınız.
