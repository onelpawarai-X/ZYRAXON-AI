...
import { Connection } from '../../jarvis-browser-core/src/client/connection';

import type { Browser } from '../../jarvis-browser-core/src/client/browser';
...
export async function connect(wsEndpoint: string, browserName: string, options: Options): Promise<Browser> {
  ...
  return jarvis._preLaunchedBrowser();
}
