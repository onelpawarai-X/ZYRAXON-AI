...
Som standard bruger ZYRAXON vårt eget `zyraxon`-tema.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/zyraxon/themes/*.json` eller `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.zyraxon/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.zyraxon/themes/*.json`
