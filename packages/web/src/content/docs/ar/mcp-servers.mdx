...
يمكن للمنظمات توفير خوادم MCP الافتراضية عبر نقطة النهاية `.well-known/zyraxon` الخاصة بها. قد تكون هذه الخوادم معطّلة افتراضيا، مما يتيح للمستخدمين تفعيل ما يحتاجونه فقط.
...
سيفتح أمر `mcp auth` متصفحك للتفويض. بعد إكمال التفويض، سيخزّن ZYRAXON الرموز بشكل آمن في `~/.local/share/zyraxon/mcp-auth.json`.
...
أضف خادم MCP الخاص بـ [Grep by Vercel](https://github.com/upstash/context71) للبحث في مقتطفات الشيفرة على GitHub.
