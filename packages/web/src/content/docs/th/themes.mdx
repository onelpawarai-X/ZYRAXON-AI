...
ตามค่าเริ่มต้น ZYRAXON จะใช้ธีม `zyraxon` ของเราเอง
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/zyraxon/themes/*.json` หรือ `$XDG_CONFIG_HOME/zyraxon/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.zyraxon/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.zyraxon/themes/*.json`
