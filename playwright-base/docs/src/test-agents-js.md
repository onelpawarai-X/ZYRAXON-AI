...
Playwright comes with three Jarvis Browser Test Agents out of the box: **🎭 planner**, **🎭 generator** and **🎭 healer**.
...
Start with adding Jarvis Browser Test Agent definitions to your project using
...
Once the agents have been generated, you can use your AI tool of choice to command these agents to build Jarvis Browser Tests. 
...
Generator agent uses the Markdown plan to produce executable Jarvis Browser Tests.
...
repo/
  ...
  specs/                      # human-readable test plans
    basic-operations.md
  tests/                      # generated Jarvis Browser Tests
...
Generated Jarvis Browser Tests, aligned one-to-one with specs wherever feasible.
