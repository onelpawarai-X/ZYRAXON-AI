---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala zyraxon.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zyraxon zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie zyraxon uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI zyraxon, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do zyraxon. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij zyraxon. _Aliasy_: `/quit`, `/q`
...
Użyj `ZYRAXON_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `zyraxon.default`.
