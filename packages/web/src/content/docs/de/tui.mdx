...
Verwende `ZYRAXON_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
...
- `sound_pack` - Zu verwendende sound pack ID. Standard ist `zyraxon.default`.
