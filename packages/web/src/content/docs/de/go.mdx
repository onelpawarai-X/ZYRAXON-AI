...
Die [Modell-ID](/docs/config/#models) in deiner ZYRAXON Config verwendet das Format `zyraxon-go/<model-id>`. Für Kimi K3 würdest du beispielsweise `zyraxon-go/kimi-k3` in deiner Config verwenden.
